<nav class="sidebar collapse white animate-left padding-24" style="z-index:5;width:300px;" id="mySidebar"><br>
    ...
    <div class="padding container bar-block">
        <a href="<?php echo $this->base_url('admin/checkin') ?>" class="bar-item button hover-shadow padding round"><i class="fa fa-address-book fa-fw margin-right text-theme"></i>เช็คอินพนักงาน</a>
        <a href="<?php echo $this->base_url('admin/schedule') ?>" class="bar-item button hover-shadow padding round"><i class="fa fa-calendar fa-fw margin-right text-theme"></i>ตารางงาน</a>
        <a href="<?php echo $this->base_url('admin/setting') ?>" class="bar-item button hover-shadow padding round"><i class="fa fa-money fa-fw margin-right text-theme"></i>จัดการค่าแรง / เวลาเข้างาน</a>
        <a href="<?php echo $this->base_url('admin/manage_staff') ?>" class="bar-item button hover-shadow padding round"><i class="fa fa-address-book-o fa-fw margin-right text-theme"></i>จัดการพนักงาน</a>
        <a href="<?php echo $this->base_url('admin/logout') ?>" class="bar-item button hover-shadow padding round red card margin-top"><i class="fa fa-sign-out fa-fw margin-right"></i>ออกจากระบบ</a>
    </div>
</nav>
