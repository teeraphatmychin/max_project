    ...
    <body>
            ...
            <div class="display-middle row col s12" style="margin:auto;float:unset">
                <div class="aw-form col l3 m6 s10 animate-top" style="margin:auto;float:unset;z-index:3">
                    <div class="xxlarge center margin-bottom form-head text-black">
                        <strong>เข้าสู่ระบบพนักงาน</strong>
                    </div>
                    <div class="form-body col padding round">
                        <div class="form-control form-group mar">
                            <input id="username" type="text" class="input text-black" name="username" value="01011018" required>
                            <label for="" class="control-label text-black large">รหัสพนักงาน</label>
                            <i class="tab-bar "></i>
                        </div>
                        <div class="form-control form-group mar">
                            <input id="password" type="password" class="input text-black" name="password" value="19960208" required>
                            <label for="" class="control-label text-black large">วัน/เดือน/ปีเกิด</label>
                            <i class="tab-bar"></i>
                        </div>


                        <div class="form-group margin-bottom mar">
                            <button class="btn-staff-login button col s12 border text-black hover-black border-black round large">เข้าสู่ระบบ</button>
                        </div>
                    </div>
                </div>
        ...
        <script type="text/javascript">
            $(document).ready(function(){
                $('.aw-form').on('click','.btn-staff-login',function(){
                    login($(this));
                });
                ...
                function login(action){
                    ...
                    if (dat) {
                        $.ajax({
                            url: "<?php echo $this->base_url('staff/check_login') ?>",
                            ...
                            success:function(data){
                                ...
                                switch (data[0]) {
                                    case 'success':
                                        ...
                                        setTimeout(function(){window.location.href = "<?php echo $this->base_url('staff/schedule') ?>"},1200);
                                        break;
                                    case 'fail':
                                        swal({
