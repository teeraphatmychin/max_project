...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 05, 2018 at 12:35 PM
...
CREATE TABLE `member` (
  ...
  `member_status` int(11) NOT NULL COMMENT '''0:เปิดการใช้งาน'',''1:ปิดการใช้งาน'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
ALTER TABLE `tb_order_detail`
  MODIFY `detail_id` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=86;
COMMIT;
