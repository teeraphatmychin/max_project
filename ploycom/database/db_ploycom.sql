...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 29, 2019 at 02:55 PM
...
(1, 'admin', '61129118', 'สุชาครีย์ ศรีสุพพรณ');
...
INSERT INTO `amphur` (`amphur_id`, `amphur_code`, `amphur_name`, `amphur_name_en`, `province_id`) VALUES
...
INSERT INTO `bank` (`bank_id`, `bank_name`, `bank_initials`, `bank_img`, `bank_name_en`, `bank_ac_number`, `bank_ac_name`, `bank_color`) VALUES
(1, 'ธนาคาร กรุงไทย จำกัด (มหาชน)', 'กรุงไทย', 'krungthai.png', 'krungthai', '654-8-78932-1', 'ร้านพลอยคอม', '#09C'),
(2, 'ธนาคาร ไทยพาณิชย์ จำกัด (มหาชน)', 'ไทยพาณิชย์', 'bangkok.png', 'thaipanich', '846-0-77548-2', 'ร้านพลอยคอม', '#660066'),
(3, 'ธนาคาร กรุงเทพ จำกัด (มหาชน)', 'กรุงเทพ', 'thaipanich.png', 'krungthap', '332-4-15480-4', 'ร้านพลอยคอม', '#039'),
(4, 'พร้อมเพย์', 'พร้อมเพย์', 'promptpay.png', 'promptpay', '099-827-7294', 'ร้านพลอยคอม', '#023863');
...
CREATE TABLE `category` (
  `category_id` int(5) UNSIGNED ZEROFILL NOT NULL COMMENT 'รหัสประเภทสินค้า',
  `category_eng_name` varchar(200) NOT NULL COMMENT 'ชื่อประเภทสินค้า',
  `category_th_name` varchar(200) NOT NULL COMMENT 'ชื่อประเภทสินค้าภาษาไทย'
...
INSERT INTO `category` (`category_id`, `category_eng_name`, `category_th_name`) VALUES
(00001, 'case', 'เคส'),
(00002, 'cpu', 'ซีพียู'),
(00003, 'harddisk', 'ฮาร์ดดิสก์\r\n'),
(00004, 'mainboard', 'เมนบอร์ด'),
(00005, 'powersupply', 'เพาว์เวอร์ซัฟพลาย'),
(00006, 'ram', 'แรม'),
(00007, 'vgacard', 'การ์ดจอ'),
(00008, 'monitor', 'หน้าจอ'),
(00009, 'keyboard', 'คีย์บอร์ด'),
(00010, 'mouse', 'เมาส์');
...
INSERT INTO `district` (`district_id`, `zipcode`, `district_name`, `district_name_en`, `amphur_id`) VALUES
...
CREATE TABLE `member` (
  ...
  `member_card_id` varchar(13) NOT NULL,
  `member_email` text NOT NULL,
  `member_phone` varchar(10) NOT NULL,
  `member_status` int(11) NOT NULL COMMENT '''0:เปิดการใช้งาน'',''1:ปิดการใช้งาน'',''2:ยังไม่ยืนยันอีเมล์'''
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `member` (`member_id`, `member_password`, `member_name`, `member_address`, `member_card_id`, `member_email`, `member_phone`, `member_status`) VALUES
(1, '61129118', 'maxki everday', '106/ม.3/ซ.ห้วยพลู3/ถ.พิษณุโลก-หล่มสัก/จ.พิษณุโลก/อ.วังทอง/ต.แก่งโสภา/65220', '3216549876546', 'maxsrisupan@gmail.com', '0995554691', 0),
(2, '654321', 'maxki everday', '106/ม.3/ซ.ห้วยพลู3/ถ.พิษณุโลก-หล่มสัก/จ.พิษณุโลก/อ.วังทอง/ต.แก่งโสภา/65220', '3216549876546', 'max@gmail.com', '0995554691', 1),
(3, '123', 'สุชาครีย์ ศรีสุพรรณ', '106 ม.3 จ.กรุงเทพมหานคร อ.เขตพระนคร ต.พระบรมมหาราชวัง 10200', '1659900745771', 'maxsa555max@gmail.com', '0998277294', 0),
(4, '12345', 'nisachon berkjai', '70/2 ม.8 ซ.- ถ.- จ.พิษณุโลก อ.บางกระทุ่ม ต.วัดตายม 65210', '1659900750198', 'nisachon.b@psru.ac.th', '0836280572', 0),
(5, '0901473689', 'เตือนตา วงษ์ภูมิ', '45/6 ม.10 ซ.- ถ.สองแคว จ.ตาก อ.แม่สอด ต.แม่สอด 63110', '5912408066123', 'tueanta.tarn@gmail.com', '0901473689', 0);
...
CREATE TABLE `payment` (
  ...
  `order_id` int(11) NOT NULL,
  `confirm_image` text NOT NULL,
  `status` int(1) NOT NULL COMMENT '''0=รอตวรสอบ'',''1=ผ่าน'',''2=ไม่ผ่าน'',''3=ลบรูปภาพ''',
...
INSERT INTO `payment` (`payment_id`, `order_id`, `confirm_image`, `status`, `upload_date`) VALUES
(1, 2, '2018-06-17 13_39_03.jpg', 3, '2018-06-17 06:39:29'),
(2, 2, '2018-06-17 13_41_49.jpg', 3, '2018-06-25 13:16:25'),
(3, 2, '2018-06-25 20_16_33.jpg', 3, '2018-06-25 13:17:00'),
(4, 6, '2018-07-01 13_38_36.jpg', 3, '2018-07-01 06:38:45'),
(5, 10, '2018-07-17 00_02_42.jpg', 3, '2018-07-16 17:30:13'),
(6, 10, '2018-07-17 00_31_44.png', 2, '2018-07-16 17:31:53'),
(7, 10, '2018-07-17 00_33_57.png', 2, '2018-07-16 17:34:21'),
(8, 11, '2018-07-17 00_58_41.jpg', 0, '2018-07-16 17:58:41'),
(9, 11, '2018-07-17 00_58_44.png', 2, '2018-07-16 17:59:46'),
(10, 11, '2018-07-17 01_00_05.png', 0, '2018-07-16 18:00:05'),
(11, 12, '2018-07-17 02_53_42.png', 2, '2018-07-24 18:09:42'),
(12, 12, '2018-07-17 02_53_46.png', 0, '2018-07-16 19:53:46'),
(13, 13, '2018-07-17 10_24_38.png', 2, '2018-07-17 03:25:12'),
(14, 16, '2018-07-25 01_03_00.png', 3, '2018-07-24 18:04:00'),
(15, 16, '2018-07-25 01_03_03.jpg', 3, '2018-07-24 18:03:57'),
(16, 16, '2018-07-25 01_04_04.png', 0, '2018-07-24 18:04:04'),
(17, 17, '2018-07-26 01_09_51.jpg', 0, '2018-07-25 18:09:51'),
(18, 18, '2018-07-26 01_20_48.png', 0, '2018-07-25 18:20:48'),
(19, 19, '2018-07-26 01_21_36.jpg', 0, '2018-07-25 18:21:36'),
(20, 20, '2018-07-30 21_55_11.jpg', 0, '2018-07-30 14:55:11'),
(21, 21, '2018-08-28 14_48_12.jpg', 2, '2018-08-28 07:48:36'),
(22, 21, '2018-08-28 14_49_03.jpg', 0, '2018-08-28 07:49:03');
...
CREATE TABLE `product` (
  ...
  `product_status` int(1) NOT NULL COMMENT '''0:แสดง'',''1:ซ่อน'''
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `product` (`product_id`, `product_name`, `product_price`, `product_detail`, `product_brand`, `product_image`, `product_amount`, `category_id`, `product_date`, `product_status`) VALUES
(1, 'AMDA6 7400k specifications', 6600, 'Model=>Brand:AMD|Model:A6-7400K#Specification=>Socket:FM2+|CPU Core / Thread:2/2|Frequency:3.50 GHz|Turbo:3.90 GHz|CPU Bus:N/A|Architecture:28nm|Cache L2:1MB|Cache L3:-|Power Peak:65W#Warranty=>การรับประกัน:3 ปี', 'AMD', 'AMDA6_7400k.jpg', 2, 2, '2018-09-04 12:20:16', 1),
(2, 'GEFORCE GTX 1060 GAMING X 6G', 12000, 'Model=>Brand:MSI|Model:GTX1060 GAMING VR X 6G#Specification=>Chipset:NVIDIA|GPU Model:NVIDIA 1000 Series|GPU Name:GP106|Bus Interface:PCI-ex 3.0 16x|Technology:16nm|ความเร็ว GPU:1569MHz|ความเร็ว RAM:2002MHz|ความจุ RAM:6GB|ชนิดของ RAM:DDR5|Bus Width:192bit#General=>Shader Mode:l5.0|Shader Unit:1280|DirectX:12|รองรับ Cross Fire / SLI:-|รองรับ 3D:Ready#Port Connector=>DSUB Port:-|DVI Port:1 Port|HDMI Port:1 Port|Mini HDMI Port:-|Display Port:3 Port|Mini Display port:-#Power Requirement=>Power Recommended:500W|Power Connectors:6 Pin#Warranty=>การรับประกัน :3 ปี', 'MSI', 'MSI GTX1060 GAMING X.jpg', 9, 7, '2018-08-28 07:49:14', 0),
(3, '4 GB RAM PC DDR3/1600 G.SKILL AEGIS', 1200, 'Model=>Brand:G.SKILL|Model:AEGIS DDR3 4GB 1600#Specification=>ชนิดแรม:DDR3|ความจุ:4GB|Voltage:-|RAM Bus:1600|CL Timing:11-11-11-28-2N#Warranty=>การรับประกัน:L/T ปี', 'G.SKILL', 'G.SKILL AEGIS DDR3 4GB 1600.jpg', 10, 6, '2018-07-15 15:41:13', 0),
(4, 'GIGABYTE GA-970 GAMING', 3500, 'Model=> Brand : GIGABYTE| Model : 970-GAMING# Support CPU=> Socket : AM3+| CPU Generation : AMD A Series| รองรับการกินไฟ CPU : 100| Mainboard Chipset : 970| CPU Series :-# Memory=> จำนวน Slot แรม : 2| ชนิดของแรม :-| ความจุแรมสูงสุด : 32 GB| Ram Bus :-# Onboard=> VGA Onboard : NONE| Audio Onboard : NONE| รองรับระบบเสียง : Flexible 8-channel Storage Connector=> Port SATA 2 : 2 Port| Port SATA 3 : 2 Port| รองรับฟังก์ชั่น RAID : 0/1/5/10| Port M.2 SSD :-# Expansion Slots=> รายละเอียดอื่นๆ :-| Slot :-# Network=> Chipset LAN : Realtek 811E| ความเร็ว LAN : 10/100/1000 Mbps# Rear Panel Ports=> Port USB 2.0 : 2 Port| Port USB 3.0 : NONE Port| Port USB 3.1 :-| Serial Port : NONE Port| Dsub Output : 1 Port| DVI Output : 1 Port| HDMI Output : NONE Port| Display Port :-| Audio Output : NONE Port| Port PS2 : 1 X PS/2 keyboard| Option Port : 1 X Optical S/PDIF out# Physical Spec=> ชนิดของเมนบอร์ด : Micro-ATX| ช่องเสียบไฟ : 24+4 Pin| ขนาด : NONE cm# Warranty=> การรับประกัน : 3 Years', 'GIGABYTE', 'GIGABYTE GA-970 GAMING.jpg', 10, 4, '2018-07-15 15:41:13', 0),
(5, 'SEAGATE BARRACUDA 3TB', 3600, 'Model=> Brand:SEAGATE| Model:BARRACUDA 3TB# Specification=> ความจุ:3TB| ขนาด Harddisk:3.5| ความเร็วจานหมุน:7200| ขนาด Buffer:64MB# Interface Connector=> Port เชื่อมต่อ:SATA III# Warranty=> การรับประกัน:3 ปี', 'SEAGATE', 'SEAGATE BARRACUDA 3TB.jpg', 8, 3, '2018-08-28 07:49:14', 0),
(6, 'TSUNAMI Black Strom', 2200, 'Model=> Brand:TSUNAMI| Model:Black Strom 850W| Series:Black Strom# Specification=> ประเภท Power Supply:ATX| กำลังไฟสูงสุด:850W| Fan Size:1 x 140mm Fan| Power Factor Correction:N/A| Mainboard Connector:20+4Pin+8Pin| PCI Ex Connector:2 x 6+2 Pin| Sata Connector:6| รองรับการ SLI:N/A| รองรับการ Cross Fire:N/A| สามารถถอดสายได้:N/A| อัตราการจ่ายพลังงาน:More than 80% at full loads, nominal line| มาตรฐานรับรอง:80 PLUS| ระบบป้องกันไฟเกิน:UVP/OUP/OPP/SCP/OCP/OVP| รองรับไฟขาเข้า:100V ~ 240V| ช่วงความถี่ขาเข้า:50~60 Hz| จำนวนชั่วโมงการใช้งาน:100,000 hours or more (60% loads, 200V/50Hz voltage input, environmental temperature 45C , humidity| ขนาด:N/A x x| Feature เพิ่มเติม:-# Warranty=> การรับประกัน:3 ปี', 'Tsunami', 'TSUNAMI Black Strom 850W.jpg', 0, 5, '2018-07-15 15:41:13', 0),
(8, 'AMD A6-7470K', 2400, 'Model=> Brand:AMD| Model:A6-7470K# Specification=> Socket:FM2+| CPU Core / Thread:2/2| Frequency:3.70 GHz| Turbo:4.00 GHz| CPU Bus:N/A| Architecture:28nm| Cache L2:1MB| Cache L3:-| Power Peak:65W# Warranty=> การรับประกัน:3 ปี', 'AMD', 'AMD A6-7470K.jpg', 10, 2, '2018-07-15 15:41:13', 0),
(9, 'CPU AMD AM3+ FX-6300 3.5 GHz', 4000, 'Model=> Brand:AMD| Model:FX-6300# Specification=> Socket:AM3+| CPU Core / Thread:6/6| Frequency:3.50 GHz| Turbo:4.10 GHz| CPU Bus:2600MHz| Architecture:32nm| Cache L2:6MB| Cache L3:8MB| Power Peak:95W# Warranty=> การรับประกัน:3 ปี', 'AMD', 'AMD FX-6300.jpg', 10, 2, '2018-07-15 15:41:13', 0),
(11, 'RAIDMAX RX-450SS', 1000, 'Model=> Brand:RAIDMAX| Model:RX-450SS| Series:RX-SS# Specification=> ประเภท Power Supply:N/A| กำลังไฟสูงสุด:450W| Fan Size:1 x 135mm Fan| Power Factor Correction:Active| Mainboard Connector:20+4 Pin| PCI Ex Connector:1 x 6+2Pin 2 Connector| Sata Connector:6| รองรับการ SLI:Ready| รองรับการ Cross Fire:N/A| สามารถถอดสายได้:Modular| อัตราการจ่ายพลังงาน:N/A| มาตรฐานรับรอง:-| ระบบป้องกันไฟเกิน:N/A| รองรับไฟขาเข้า:110 - 230 V| ช่วงความถี่ขาเข้า:47/63 Hz| จำนวนชั่วโมงการใช้งาน:N/A| ขนาด:150mm x 158mm x 86mm| Feature เพิ่มเติม:-# Warranty=> การรับประกัน:3 ปี', 'RAIDMAX', 'RAIDMAX RX-450SS.jpg', 10, 5, '2018-07-15 15:41:13', 0),
(14, 'ZOTAC GTX1050 Mini', 4280, 'Model=> Brand:Zotac| Model:GTX1050Ti Mini# Specification=> Chipset:NVIDIA| GPU Model:NVIDIA 1000 Series| GPU Name:GP107| Bus Interface:PCI-ex 3.0 16x| Technology:14nm| ความเร็ว GPU:1303MHz| ความเร็ว RAM:3504MHz| ความจุ RAM:4GB| ชนิดของ RAM:DDR5| Bus Width:128bit# General=> Shader Model:5.0| Shader Unit:768# DirectX12=> รองรับ Cross Fire / SLI:-| รองรับ 3D:-# Port Connector=> DSUB Port:-| DVI Port:1 Port| HDMI Port:1 Port| Mini HDMI Port:-| Display Port:1 Port| Mini Display port:-# Power Requirement=> Power Recommended:400W| Power Connectors:-# Warranty=> การรับประกัน: 3 ปี', 'ZOTAC ', 'ZOTAC GTX1050 Mini.jpg', 10, 7, '2018-07-15 15:41:13', 0),
(15, 'GIGABYTE GTX1050 D5 2G', 4690, 'Model=> Brand:GIGABYTE| Model:GTX1050 D5 2G# Specification=> Chipset:NVIDIA| GPU Model:NVIDIA 1000 Series| GPU Name:GP107| Bus Interface:PCI-ex 3.0 16x| Technology:14nm| ความเร็ว GPU:1354MHz| ความเร็ว RAM:3504MHz| ความจุ RAM:2GB| ชนิดของ RAM:DDR5| Bus Width:128bit# General=> Shader Model:5.0| Shader Unit:640| DirectX:12| รองรับ Cross Fire / SLI:-| รองรับ 3D:-# Port Connector=> DSUB Port:-| DVI Port:1 Port| HDMI Port:1 Port| Mini HDMI Port:-| Display Port:1 Port| Mini Display port:-# Power Requirement=> Power Recommended:300W| Power Connectors:-# Warranty=> การรับประกัน: 3 ปี', 'GIGABYTE', 'GIGABYTE GTX1050 D5 2G.jpg', 10, 7, '2018-07-15 15:41:13', 0),
(16, 'G.SKILL Ripjaws X DDR3 4GB 1600 RL', 1420, 'Model=> Brand:G.SKILL| Model:Ripjaws X DDR3 4GB 1600 RL# Specification=> ชนิดแรม:DDR3| ความจุ:4GB| Voltage:-| RAM Bus:1600| CL Timing:9# Warranty=> การรับประกัน:L/T ปี', 'G.SKILL', 'G.SKILL Ripjaws X DDR3 4GB 1600 RL.jpg', 10, 6, '2018-07-15 15:41:13', 0),
(17, 'KINGSTON Hyper-X Fury DDR4 4GB 2400 Black', 1380, 'Model=> Brand:KINGSTON| Model:Hyper-X Fury DDR4 4GB 2400 Black# Specification=> ชนิดแรม:DDR4| ความจุ:4GB| Voltage:-| RAM Bus:2400| CL Timing:15-15-15# Warranty=> การรับประกัน:L/T ปี', 'KINGSTON', 'KINGSTON Hyper-X Fury DDR4 4GB 2400 Black.jpg', 10, 6, '2018-07-15 15:41:13', 0),
(18, 'AMD Ryzen 3 2200G', 3180, 'Model=> Brand:AMD| Model:Ryzen 3 2200G# Specification=> Socket:AM4| CPU Core / Thread:4/4| Frequency:3.50 GHz| Turbo:3.70 GHz| CPU Bus:8 GT/s DMI3| Architecture:14nm| Cache L2:2MB| Cache L3:4MB| Power Peak:65W# Warranty=> การรับประกัน:3 ปี', 'AMD', 'AMD Ryzen 3 2200G.png', 10, 2, '2018-07-15 15:41:13', 0),
(19, 'MSI A320M PRO-VD/S', 1650, 'Model=> Brand:MSI| Model:A320M PRO-VD/S# Support CPU=> Socket:AM4| CPU Support:Supports AMD Socket AM4 A-Series APUs (Bristol Ridge) & Ryzen Series CPUs (Summit Ridge)| รองรับการกินไฟ CPU:-| Mainboard Chipset:AMD A320# Memmory=> จำนวน Slot แรม:2| ความจุแรมสูงสุด:32GB| ชนิดของแรม:Supports Dual Channel DDR4 3200(O.C.)/2933(O.C.)/2666/2400/2133 MHz# Onboard=> VGA Onboard Chip:Integrated AMD Radeon R-Series Graphics in A-series APU| Audio Chip:Realtek ALC887 Audio Codec| รองรับระบบเสียง:7.1 Channels HD Audio# Storage Connector=> Port SATA 2:0| Port SATA 3:4| M.2 Slot:0| M.2 Supports type:-| รองรับฟังก์ชั่น RAID:0/1/10# Expansion Slots=> รายละเอียด:1 Slot PCIe x16 2 Slot PCIe x1| รับรอง Cross Fire / SLI:-# Network=> Chipset LAN:Realtek RTL8111H| ความเร็ว LAN:10/100/1000Mbps# Rear Panel Ports=> Port USB 2.0:2 Port| Port USB 3.0:0 Port| Port USB 3.1 :Type-A 4 Port| Dsub Output:1 Port| DVI Output:1 Port| HDMI Output:0 Port| Mini HDMI Outputv:0 Port| Display port:0 Port| Mini Display port:0 Port| Audio Output:3 Port| Port PS2:1 Port| Option Port:-# Physical Spec=> ชนิดของเมนบอร์ด:Micro-ATX| ช่องเสียบไฟ:24+8 Pin| ขนาด:23.6 x 18.7 cm# Warranty=> การรับประกัน:3 ปี', 'MSI', 'MSI A320M PRO.png', 10, 4, '2018-07-15 15:41:13', 0),
(20, 'GALAX GTX1050 OC', 4290, 'Model=> Brand:GALAX| Model:GTX1050 OC# Specification=> Chipset:NVIDIA| GPU Model:NVIDIA 1000 Series| GPU Name:GP107| Bus Interface:PCI-ex 3.0 16x| Technology:14nm| ความเร็ว GPU:1366MHz| ความเร็ว RAM:3504MHz| ความจุ RAM:2GB| ชนิดของ RAM:DDR5| Bus Width:128bit# General=> Shader Model:5.0| Shader Unit:640| DirectX:12| รองรับ Cross Fire / SLI:-| รองรับ 3D:-# Port Connector=> DSUB Port:-| DVI Port:1 Port| HDMI Port:1 Port| Mini HDMI Port:-| Display Port:1 Port| Mini Display port:-# Power Requirement=> Power Recommended:350W| Power Connectors:-# Warranty=> การรับประกัน: 3 ปี', 'GALAX', 'GALAX GTX1050 OC.jpg', 10, 7, '2018-07-15 15:41:13', 0),
(21, 'INTEL Core i5-8400', 6900, 'Model=> Brand:INTEL| Model:Core i5-8400# Specification=> Socket:LGA1151-v2| CPU Core / Thread:6/6| Frequency:2.80 GHz| Turbo:4.00 GHz| CPU Bus:8 GT/s DMI3| Architecture:14nm| Cache L2:6 x 256KB| Cache L3:9MB| Power Peak:65W# Warranty=> การรับประกัน:3 ปี', 'INTEL', 'INTEL Core i5-8400.png', 10, 2, '2018-07-15 15:41:13', 0),
(22, 'MSI H310M PRO-VDH', 2150, 'Model=> Brand:MSI| Model:H310M PRO-VDH# Support CPU=> Socket:LGA1151-v2| CPU Support:Intel 8th Generation Core Processors| รองรับการกินไฟ CPU:-| Mainboard Chipset:Intel H310# Memmory=> จำนวน Slot แรม:2| ความจุแรมสูงสุด:32GB| ชนิดของแรม:Supports Dual Channel DDR4 2666/2400/2133 MHz# Onboard=> VGA Onboard Chip:Integrated Graphics Processor| Audio Chip:Realtek ALC887 Audio Codec| รองรับระบบเสียง:7.1 Channels HD Audio#| Storage Connector=> Port SATA 2:0| Port SATA 3:4| M.2 Slot:0| M.2 Supports type:-| รองรับฟังก์ชั่น RAID:-# Expansion Slots=> รายละเอียด:1 Slot PCIe x16 2 Slot PCIe x1| รับรอง Cross Fire / SLI:-# Network=> Chipset LAN:Realtek® RTL8111H| ความเร็ว LAN:10/100/1000Mbps# Rear Panel Ports=> Port USB 2.0:4 Port| Port USB 3.0:0 Port| Port USB 3.1: Type-A 2 Port| Dsub Output:1 Port| DVI Output:1 Port| HDMI Output:1 Port| Mini HDMI Outputv:0 Port| Display port:0 Port| Mini Display port:0 Port| Audio Output:3 Port| Port PS2:1 Port| Option Port:-# Physical Spec=> ชนิดของเมนบอร์ด:Micro-ATX| ช่องเสียบไฟ:24+8 Pin| ขนาด:22.6 x 18.5 cm# Warranty=> การรับประกัน:3 ปี', 'MSI', 'MSI H310M PRO-VDH.png', 10, 4, '2018-07-15 15:41:13', 0),
(23, 'G.SKILL DDR4 8GB (4GBx2) 2400 (GNT)', 3200, 'Model=> Brand:G.SKILL| Model:DDR4 8GB (4GBx2) 2400 (GNT)# Specification=> ชนิดแรม:DDR4| ความจุ:8GB (4GBx2)| Voltage:1.2| RAM Bus:2400| CL Timing:17-17-17-39# Warranty=> การรับประกัน:L/T ปี', 'G.SKILL', 'G.SKILL DDR4 8GB (4GBx2) 2400 (GNT).png', 10, 6, '2018-07-15 15:41:13', 0),
(24, 'SEAGATE BARRACUDA 1TB', 1350, 'Model=> Brand:SEAGATE| Model:BARRACUDA 1TB# Specification=> ความจุ:1TB| ขนาด :Harddisk3.5| ความเร็วจานหมุน:7200| ขนาด Buffer:64MB# Interface Connector=> Port เชื่อมต่อ:SATA III# Warranty=> การรับประกัน:3 ปี', 'SEAGATE', 'SEAGATE BARRACUDA 3TB.jpg', 10, 3, '2018-07-15 15:41:13', 0),
(25, 'CUBIC Blackshield', 450, '', 'CUBIC', 'CUBIC.jpg', 10, 1, '2018-07-15 15:41:13', 0),
(26, 'NEOLUTION Gamemaster Pro 700W', 890, 'Model=> Brand:NEOLUTION| Model:Gamemaster Pro 700W| Series:Gamemaster Pro# Specification=> ประเภท Power Supply:ATX 12V 2.1| กำลังไฟสูงสุด:700W| Fan Size:1 x 120mm Fan| Power Factor Correction:Active| Mainboard Connector:20+4 Pin| PCI Ex Connector:1 x 6+2-Pin| Sata Connector:3| รองรับการ SLI:N/A| รองรับการ Cross Fire:N/A| สามารถถอดสายได้:Modular| อัตราการจ่ายพลังงาน:>75%| มาตรฐานรับรอง:-| ระบบป้องกันไฟเกิน:Yes| รองรับไฟขาเข้า:110 - 230 V| ช่วงความถี่ขาเข้า:50-60Hz| จำนวนชั่วโมงการใช้งาน:>50,000 Hours| ขนาด:150mm x 140mm x 86mm| Feature เพิ่มเติม:-# Warranty=> การรับประกัน:3 ปี', 'NEOLUTION', 'NEOLUTION Gamemaster Pro 700W.png', 10, 5, '2018-07-15 15:41:13', 0),
(27, 'MSI GTX1050Ti 4GT OC', 6520, 'Model=> Brand:MSI| Model:GTX1050Ti 4GT OC# Specification=> Chipset:NVIDIA| GPU Model:NVIDIA 1000 Series| GPU Name:GP107| Bus Interface:PCI-ex 3.0 16x| Technology:14nm| ความเร็ว GPU:1341MHz| ความเร็ว RAM:3504MHz| ความจุ RAM:4GB| ชนิดของ RAM:DDR5| Bus Width:128bit# General=> Shader Model:5.0| Shader Unit:768| DirectX:12| รองรับ Cross Fire / SLI:-| รองรับ 3D:-# Port Connector=> DSUB Port:-| DVI Port:1 Port| HDMI Port:1 Port| Mini HDMI Port:-| Display Port:1 Port| Mini Display port:-# Power Requirement=> Power Recommended:450W| Power Connectors:-# Warranty=> การรับประกัน: 3 ปี', 'MSI', 'MSI GTX1050Ti 4GT OC.jpg', 10, 7, '2018-07-15 15:41:13', 0),
(28, 'RAIDMAX RX-700AC', 2390, 'Model=> Brand:RAIDMAX| Model:RX-700AC| Series:RX-AC# Specification=> ประเภท Power Supply:ATX 12V2.2| กำลังไฟสูงสุด:700W| Fan Size:1 x 120mm Fan| Power Factor Correction:Active| Mainboard Connector:20+4 Pin| PCI Ex Connector:2 x 6+2Pin| Sata Connector:6| รองรับการ SLI:N/A| รองรับการ Cross Fire:N/A| สามารถถอดสายได้:N/A| อัตราการจ่ายพลังงาน:N/A| มาตรฐานรับรอง:80 PLUS Certified| ระบบป้องกันไฟเกิน:Yes| รองรับไฟขาเข้า:N/A| ช่วงความถี่ขาเข้า:N/A| จำนวนชั่วโมงการใช้งาน:N/A| ขนาด:N/A x N/A x N/A| Feature เพิ่มเติม:-# Warranty=> การรับประกัน:3 ปี', 'RAIDMAX', 'RAIDMAX RX-700AC.jpg', 10, 5, '2018-07-15 15:41:13', 0),
(29, 'ASUS GTX1060 DUAL 3GB OC', 7190, 'Model=> Brand:ASUS| Model:GTX1060 DUAL 3GB OC# Specification=> Chipset:NVIDIA| GPU Model:NVIDIA 1000 Series| GPU Name:GP106| Bus Interface:PCI-ex 3.0 16x| Technology:16nm| ความเร็ว GPU:1569MHz| ความเร็ว RAM:2002MHz| ความจุ RAM:3GB| ชนิดของ RAM:DDR5| Bus Width:192bit# General=> Shader Model:5.0| Shader Unit1:152| DirectX:12| รองรับ Cross Fire / SLI:-| รองรับ 3D:Ready# Port Connector=> DSUB Port:-| DVI Port:1 Port| HDMI Port:2 Port| Mini HDMI Port:-| Display Port:2 Port| Mini Display port:-# Power Requirement=> Power Recommended:500W| Power Connectors:6 Pin# Warranty=> การรับประกัน: 3 ปี', 'ASUS', 'ASUS GTX1060 DUAL 3GB OC.jpg', 10, 7, '2018-07-15 15:41:13', 0),
(30, 'CORSAIR Vengeance LPX DDR4 8GB 2400 (4GBx2) Black', 3850, 'Model=> Brand:CORSAIR| Model: Vengeance LPX DDR4 8GB 2400 (4GBx2) Black# Specification=> ชนิดแรม:DDR4| ความจุ:8GB (4GBx2)| Voltage:-| RAM Bus:2400| CL Timing:14-16-16-31# Warranty=> การรับประกัน:L/T ปี', 'CORSAIR', 'CORSAIR Vengeance LPX DDR4 8GB 2400 (4GBx2) Black.jpg', 10, 6, '2018-07-15 15:41:13', 0),
(31, 'WESTERN DIGITAL Black 1TB WD1003FZEX', 2480, 'Model=> Brand:Western Digital| Model:Black 1TB WD1003FZEX# Specification=> ความจุ:1TB| ขนาด :Harddisk3.5| ความเร็วจานหมุน:7200| ขนาด Buffer:64MB# Interface Connector=> Port เชื่อมต่อ:SATA III# Warranty=> การรับประกัน:5 ปี', 'Western Digital', 'WESTERN DIGITAL Black 1TB WD1003FZEX.jpg', 10, 3, '2018-07-15 15:41:13', 0),
(32, 'TSUNAMI Pro Hero K15 Black-Blue', 1300, '', 'Tsunami', 'TSUNAMI Pro Hero K15 Black-Blue.png', 10, 1, '2018-07-15 15:41:13', 0),
(33, 'COUGAR STX750 750W', 2190, 'Model=> Brand:COUGAR| Model:STX750 750W| Series:STX Series# Specification=> ประเภท Power Supply:ATX| กำลังไฟสูงสุด:750W| Fan Size:1 x 120mm Fan| Power Factor Correction:Active| Mainboard Connector:20+4-Pin| PCI Ex Connector:4 x 6+2-Pin| Sata Connector:6| รองรับการ SLI:Ready| รองรับการ Cross Fire:Ready| สามารถถอดสายได้:Modular| อัตราการจ่ายพลังงาน:88% Typically| มาตรฐานรับรอง:80 Plus White| ระบบป้องกันไฟเกิน:UVP, OVP, SCP, OPP, OCP| รองรับไฟขาเข้า:200-240 Vac 5A| ช่วงความถี่ขาเข้า:50-60Hz| จำนวนชั่วโมงการใช้งาน:>100,000 hours| ขนาด:150mm x 140mm x 86mm| Feature เพิ่มเติม:-# Warranty=> การรับประกัน:3 ปี', 'COUGAR', 'COUGAR STX750 750W.png', 10, 5, '2018-07-15 15:41:13', 0),
(34, 'MSI B360M PRO-VDH', 2520, 'Model=> Brand:MSI| Model:B360M PRO-VDH# Support CPU=> Socket:LGA1151-v2| CPU Support:Intel 8th Generation Core Processors| รองรับการกินไฟ CPU:-| Mainboard Chipset:Intel B360# Memmory=> จำนวน Slot แรม:2| ความจุแรมสูงสุด:32GB| ชนิดของแรม:Supports Dual Channel DDR4 2666/2400/2133 MHz# Onboard=> VGA Onboard Chip:Integrated Graphics Processor| Audio Chip:Realtek ALC887 Audio Codec| รองรับระบบเสียง:7.1 Channels HD Audio# Storage Connector=> Port SATA 2:0| Port SATA 3:6| M.2 Slot:1| M.2 Supports type:2242/2260/2280/22110| รองรับฟังก์ชั่น RAID:-# Expansion Slots=> รายละเอียด:1 Slot PCIe x16 2 Slot PCIe x1| รับรอง Cross Fire / SLI:-# Network=> Chipset LAN:Realtek RTL8111H| ความเร็ว LAN:10/100/1000Mbps# Rear Panel Ports=> Port USB 2.0:2 Port| Port USB 3.0:0 Port| Port USB 3.1 :Type-A 3 Port / Type-C 1 Port| Dsub Output:1 Port| DVI Output:1 Port| HDMI Output:1 Port| Mini HDMI Outputv:0 Port| Display port:0 Port| Mini Display port:0 Port| Audio Output:3 Port| Port PS2:2 Port| Option Port:-# Physical Spec=> ชนิดของเมนบอร์ด:Micro-ATX| ช่องเสียบไฟ:24+8 Pin| ขนาด:24.4 x 24.4 cm# Warranty=> การรับประกัน:3 ปี', 'MSI', 'MSI B360M PRO-VDH.png', 10, 4, '2018-07-15 15:41:13', 0),
(35, 'MSI H310M PRO-M2', 2090, 'Model=> Brand:MSI| Model:B360M PRO-VDH# Support CPU=> Socket:LGA1151-v2| CPU Support:Intel 8th Generation Core Processors| รองรับการกินไฟ CPU:-| Mainboard Chipset:Intel B360# Memmory=> จำนวน Slot แรม:2| ความจุแรมสูงสุด:32GB| ชนิดของแรม:Supports Dual Channel DDR4 2666/2400/2133 MHz# Onboard=> VGA Onboard Chip:Integrated Graphics Processor| Audio Chip:Realtek ALC887 Audio Codec| รองรับระบบเสียง:7.1 Channels HD Audio# Storage Connector=> Port SATA 2:0| Port SATA 3:6| M.2 Slot:1| M.2 Supports type:2242/2260/2280/22110| รองรับฟังก์ชั่น RAID:-# Expansion Slots=> รายละเอียด:1 Slot PCIe x16 2 Slot PCIe x1| รับรอง Cross Fire / SLI:-# Network=> Chipset LAN:Realtek RTL8111H| ความเร็ว LAN:10/100/1000Mbps# Rear Panel Ports=> Port USB 2.0:2 Port| Port USB 3.0:0 Port| Port USB 3.1 :Type-A 3 Port / Type-C 1 Port| Dsub Output:1 Port| DVI Output:1 Port| HDMI Output:1 Port| Mini HDMI Outputv:0 Port| Display port:0 Port| Mini Display port:0 Port| Audio Output:3 Port| Port PS2:2 Port| Option Port:-# Physical Spec=> ชนิดของเมนบอร์ด:Micro-ATX| ช่องเสียบไฟ:24+8 Pin| ขนาด:24.4 x 24.4 cm# Warranty=> การรับประกัน:3 ปี', 'MSI', 'MSI H310M PRO-M2.png', 10, 4, '2018-07-15 15:41:13', 0),
(36, 'AMD Ryzen 5 1600X', 7350, 'Model=> Brand:AMD| Model:Ryzen 5 1600X# Specification=> Socket:AM4| CPU Core / Thread:6/12| Frequency:3.60 GHz| Turbo:4.00 GHz| CPU Bus:-| Architecture:14 nm| Cache L2:3MB| Cache L3:16MB| Power Peak:95W# Warranty=> การรับประกัน:3 ปี', 'AMD', 'AMD Ryzen 5 1600X.png', 10, 2, '2018-07-15 15:41:13', 0),
(37, 'MSI X370 GAMING PRO CARBON', 4990, 'Model=> Brand:MSI| Model:X370 GAMING PRO CARBON# Support CPU=> Socket:AM4| CPU Support:Supports AMD Socket AM4 A-Series APUs (Bristol Ridge) & Ryzen Series CPUs (Summit Ridge)| รองรับการกินไฟ CPU:-| Mainboard Chipset:AMD X370# Memmory=> จำนวน Slot แรม:4| ความจุแรมสูงสุด:64GB| ชนิดของแรม:Supports Dual Channel DDR4 3200(O.C.)/2933(O.C.)/2666/2400/2133 MHz# Onboard=> VGA Onboard Chip:Integrated Graphics Processor| Audio Chip:Realtek ALC1220 Audio Codec| รองรับระบบเสียง:7.1 Channels HD Audio# Storage Connector=> Port SATA 2:0| Port SATA 3:6| M.2 Slot:2| M.2 Supports type:2242/2260/2280| รองรับฟังก์ชั่น RAID:0/1/10# Expansion Slots=> รายละเอียด:1 Slot PCIe x16 1 Slot PCIe x8 1 Slot PCIe x4 3 Slot PCIe x1| รับรอง Cross Fire / SLI :2-Way SLI 3-Way Cross Fire# Network=> Chipset LAN:Intel I211-AT| ความเร็ว LAN:10/100/1000Mbps# Rear Panel Ports=> Port USB 2.0:2 Port| Port USB 3.0:0 Port| Port USB 3.1: Type-A 5 Port / Type-C 1 Port| Dsub Output:0 Port| DVI Output:1 Port| HDMI Output:1 Port| Mini HDMI Outputv:0 Port| Display port:0 Port| Mini Display port:0 Port| Audio Output:5 Port| Port PS2:1 Port| Option Port:-# Physical Spec=> ชนิดของเมนบอร์ด:ATX| ช่องเสียบไฟ:24+8 Pin| ขนาด:30.5 x 24.4 cm#Warranty=> การรับประกัน:3 ปี', 'MSI', 'MSI X370 GAMING PRO CARBON.png', 10, 4, '2018-07-15 15:41:13', 0),
(38, 'ZOTAC GTX1060 AMP! Edition', 9690, 'Model=> Brand:Zotac| Model:GTX1060 AMP! Edition# Specification=> Chipset:NVIDIA| GPU Model:NVIDIA 1000 Series| GPU Name:GP106| Bus Interface:PCI-ex 3.0 16x| Technology:16nm| ความเร็ว GPU:1556MHz| ความเร็ว RAM:2002MHz| ความจุ RAM:6GB| ชนิดของ RAM:DDR5| Bus Width:192bit# General=> Shader Model:5.0| Shader Unit:1280| DirectX:12| รองรับ Cross Fire / SLI:-| รองรับ 3D:Ready# Port Connector=> DSUB Port:-| DVI Port:1 Port| HDMI Port:1 Port| Mini HDMI Port:-| Display Port:3 Port| Mini Display port:-# Power Requirement=> Power Recommended:500W| Power Connectors:6 Pin# Warranty=> การรับประกัน: 3 ปี', 'Zotac', 'ZOTAC GTX1060 AMP! Edition.jpg', 10, 7, '2018-07-15 15:41:13', 0),
(39, 'TSUNAMI Pro Hero K15 White-White', 1300, '', 'Tsunami', 'TSUNAMI Pro Hero K15 White-White.png', 10, 1, '2018-07-15 15:41:13', 0),
(40, 'KINGSTON Hyper-X Fury DDR4 8GB 2666 Black', 2750, 'Model=> Brand:KINGSTON| Model:Hyper-X Fury DDR4 8GB 2666 Black# Specification=> ชนิดแรม:DDR4| ความจุ:8GB| Voltage:-| RAM Bus:2666| CL Timing:15-17-17# Warranty=> การรับประกัน:L/T ปี', 'KINGSTON', 'KINGSTON Hyper-X Fury DDR4 8GB 2666 Black.jpg', 10, 6, '2018-07-15 15:41:13', 0),
(41, 'AMD Ryzen 7 2700X', 11900, 'Model=> Brand:AMD| Model:Ryzen 7 2700X# Specification=> Socket:AM4| CPU Core / Thread:8/16| Frequency:3.70| Turbo:4.35| CPU Bus:8 GT/s DMI3| Architecture:12nm| Cache L2:4MB| Cache L3:16MB| Power Peak:105W# Warranty=> การรับประกัน:3 ปี', 'AMD', 'AMD Ryzen 7 2700X.png', 10, 2, '2018-07-15 15:41:13', 0),
(42, 'GIGABYTE AX370 Gaming K3', 3690, 'Model=> Brand:GIGABYTE| Model:AX370 Gaming K3# Support CPU=> Socket:AM4| CPU Support:Supports AMD Socket AM4 A-Series APUs (Bristol Ridge) & Ryzen Series CPUs (Summit Ridge)| รองรับการกินไฟ CPU:-| Mainboard Chipset:AMD X370# Memmory=> จำนวน Slot แรม:4| ความจุแรมสูงสุด:64GB| ชนิดของแรม:Supports Dual Channel DDR4 3200(O.C.)/2933(O.C.)/2666/2400/2133 MHz# Onboard=> VGA Onboard Chip:Integrated AMD Radeon R-Series Graphics in A-series APU| Audio Chip:Realtek ALC1220 Audio Codec| รองรับระบบเสียง:7.1 Channels HD Audio# Storage Connector=> Port SATA 2:0| Port SATA 3:8| M.2 Slot:1| M.2 Supports type:2242/2260/2280/22110| รองรับฟังก์ชั่น RAID:0/1/10# Expansion Slots=> รายละเอียด:1 Slot PCIe x16, 1 Slot PCIe x4, 3 Slot PCIe x1| รับรอง Cross Fire / SLI:-# Network=> Chipset LAN:Killer E2500| ความเร็ว LAN:10/100/1000Mbps# Rear Panel Ports=> Port USB 2.0:0 Port| Port USB 3.0:0 Port| Port USB 3.1: Type-A 8 Port| Dsub Output:0 Port| DVI Output:0 Port| HDMI Output:1 Port| Mini HDMI Outputv:0 Port| Display port:0 Port| Mini Display port:0 Port| Audio Output:5 Port| Port PS2:1 Port| Option Port:-# Physical Spec=> ชนิดของเมนบอร์ด:ATX| ช่องเสียบไฟ:24+8 Pin| ขนาด:30.5 x 24.4 cm# Warranty=> การรับประกัน:3 ปี', 'GIGABYTE', 'GIGABYTE AX370 Gaming K3.png', 10, 4, '2018-07-15 15:41:13', 0),
(43, 'KINGSTON Hyper-X DDR4 8GB 2400 White', 3150, 'Model=> Brand:KINGSTON| Model:Hyper-X DDR4 8GB 2400 White# Specification=> ชนิดแรม:DDR4| ความจุ:8GB| Voltage:1.2| RAM Bus:2400| CL Timing:15-15-15# Warranty=> การรับประกัน:L/T ปี', 'KINGSTON', 'KINGSTON Hyper-X DDR4 8GB 2400 White.png', 10, 6, '2018-07-15 15:41:13', 0),
(44, 'WESTERN DIGITAL Blue 1TB WD10EZEX', 1250, 'Model=> Brand:Western Digital| Model:Blue 1TB WD10EZEX# Specification=> ความจุ:1TB| ขนาด :Harddisk3.5| ความเร็วจานหมุน:7200| ขนาด Buffer:64MB# Interface Connector=> Port เชื่อมต่อ:SATA III# Warranty=> การรับประกัน:3 ปี', 'Western Digital', 'WESTERN DIGITAL Blue 1TB WD10EZEX.jpg', 10, 3, '2018-07-15 15:41:13', 0),
(45, 'AERO COOL CyberX Advance', 1650, '', 'AERO COOL', 'AERO COOL CyberX Advance.png', 10, 1, '2018-07-15 15:41:13', 0),
(46, 'AMD Ryzen 5 1500X', 5670, 'Model=> Brand:AMD| Model:Ryzen 5 1500X# Specification=> Socket:AM4| CPU Core / Thread:4/8| Frequency:3.50 GHz| Turbo:3.70 GHz| CPU Bus:-| Architecture:14 nm| Cache L2:2MB| Cache L3:16MB| Power Peak:65W# Warranty=> การรับประกัน:3 ปี', 'AMD', 'AMD Ryzen 5 1500X.png', 10, 2, '2018-07-15 15:41:13', 0),
(47, 'ASUS PRIME A320M-K', 1150, 'Model=> Brand:ASUS| Model:PRIME A320M-K# Support CPU=> Socket:AM4| CPU Support:Supports AMD Socket AM4 A-Series APUs (Bristol Ridge) & Ryzen Series CPUs (Summit Ridge)| รองรับการกินไฟ CPU:-| Mainboard Chipset:AMD A320# Memmory=> จำนวน Slot แรม:2| ความจุแรมสูงสุด:32GB| ชนิดของแรม:Supports Dual Channel DDR4 3200(O.C.)/2933(O.C.)/2666/2400/2133 MHz# Onboard=> VGA Onboard Chip:Integrated AMD Radeon R-Series Graphics in A-series APU| Audio Chip:Realtek ALC887 Audio Codec| รองรับระบบเสียง:8 Channels HD Audio# Storage Connector=> Port SATA 2:0| Port SATA 3:4| M.2 Slot:2| M.2 Supports type:2242/2260/2280| รองรับฟังก์ชั่น RAID:0/1/10# Expansion Slots=> รายละเอียด:1 Slot PCIe x16, 2 Slot PCIe x1| รับรอง Cross Fire / SLI:-# Network=> Chipset LAN:Realtek RTL8111H| ความเร็ว LAN:10/100/1000Mbps# Rear Panel Ports=> Port USB 2.0:2 Port| Port USB 3.0:0 Port| Port USB 3.1 :Type-A 4 Port| Dsub Output:1 Port| DVI Output:0 Port| HDMI Output:1 Port| Mini HDMI Outputv:0 Port| Display port:0 Port| Mini Display port:0 Port| Audio Output:3 Port| Port PS2:2 Port| Option Port:-# Physical Spec=> ชนิดของเมนบอร์ด:Micro-ATX| ช่องเสียบไฟ:24+4 Pin| ขนาด:22.6 x 22.1 cm# Warranty=> การรับประกัน:3 ปี', 'ASUS', 'ASUS PRIME A320M-K.png', 10, 4, '2018-07-15 15:41:13', 0),
(48, 'ASUS RX480 STRIX OC', 11900, 'Model=> Brand:ASUS| Model:RX480 STRIX OC# Specification=> Chipset:AMD| GPU Model:Radeon RX 400| GPU Name:Ellesmere| Bus Interface:PCI-ex 3.0 16x| Technology:14nm| ความเร็ว GPU:1120MHz| ความเร็ว RAM:2000MHz| ความจุ RAM:8GB| ชนิดของ RAM:DDR5| Bus Width:256bit# General=> Shader Model:5.0| Shader Unit:2304| DirectX:12| รองรับ Cross Fire / SLI:Crossfire Ready| รองรับ 3D:Ready# Port Connector=> DSUB Port:-| DVI Port:1 Port| HDMI Port:2 Port| Mini HDMI Port:-| Display Port:2 Port| Mini Display port:-# Power Requirement=> Power Recommended:600W| Power Connectors:8 Pin# Warranty=> การรับประกัน: 3 ปี', 'ASUS', 'ASUS RX480 STRIX OC.jpg', 10, 7, '2018-07-15 15:41:13', 0),
(49, 'G.SKILL Aegis DDR4 32GB 2400 (16GBx2)', 1220, 'Model=> Brand:G.SKILL| Model:Aegis DDR4 32GB 2400 (16GBx2)# Specification=> ชนิดแรม:DDR4| ความจุ:32GB (16GBx2)| Voltage:1.2| RAM Bus:2400| CL Timing:15-15-15-36# Warranty=> การรับประกัน:L/T ปี', 'G.SKILL', 'G.SKILL Aegis DDR4 32GB 2400 (16GBx2).png', 10, 6, '2018-07-15 15:41:13', 0),
(50, 'COOLER MASTER MasterBox TD500 RGB', 2490, '', 'COOLER MASTER', 'COOLER MASTER MasterBox TD500 RGB.png', 10, 1, '2018-07-15 15:41:13', 0),
(51, 'TSUNAMI Black Widow 700W', 2590, 'Model=> Brand:TSUNAMI| Model:Black Widow 700W| Series:Black Widow series# Specification=> ประเภท Power Supply:ATX 12V V2.3| กำลังไฟสูงสุด:700W| Fan Size:1 x 140mm Fan| Power Factor Correction:Active| Mainboard Connector:20+4-Pin| PCI Ex Connector:4 x 6+2-Pin| Sata Connector:6| รองรับการ SLI:N/A| รองรับการ Cross Fire:N/A| สามารถถอดสายได้:Modular| อัตราการจ่ายพลังงาน:82-85% efficiency| มาตรฐานรับรอง:80 PLUS Brozne| ระบบป้องกันไฟเกิน:OVP/SCP/UVP/OTP| รองรับไฟขาเข้า:100 - 240 V| ช่วงความถี่ขาเข้า:47/63 Hz| จำนวนชั่วโมงการใช้งาน:>100,000 hours| ขนาด:150mm x 160mm x 86mm| Feature เพิ่มเติม:-# Warranty=> การรับประกัน:3 ปี', 'TSUNAMI', 'TSUNAMI Black Widow 700W.png', 10, 5, '2018-07-15 15:41:13', 0),
(52, 'INTEL Core i5-6400', 5790, 'Model=> Brand:INTEL| Model:Core i5-6400# Specification=> Socket:LGA1151| CPU Core / Thread:4/4| Frequency:2.70 GHz| Turbo:3.30 GHz| CPU Bus:8 GT/s DMI| Architecture:14nm| Cache L2:4 x 256KB| Cache L3:6MB| Power Peak:65W# Warranty=> การรับประกัน:3 ปี', 'INTEL', 'INTEL Core i5-6400.png', 10, 2, '2018-07-15 15:41:13', 0),
(53, 'ASROCK H110M-DVS', 1560, 'Model=> Brand:ASROCK| Model:H110M-DVS# Support CPU=> Socket:LGA1151| CPU Support:Intel 6th Generation Pentium/Celeron/Core i3/Core i5/Core i7 processors| รองรับการกินไฟ CPU:-| Mainboard Chipset:Intel H110# Memmory=> จำนวน Slot แรม:2| ความจุแรมสูงสุด:32GB| ชนิดของแรม:Dual Channel DDR4 2133 MHz# Onboard=> VGA Onboard Chip:Intel HD Graphics Processor| Audio Chip:Realtek ALC887 Audio Codec| รองรับระบบเสียง:7.1 Channels HD Audio# Storage Connector=> Port SATA 2:0| Port SATA 3:4| M.2 Slot:0| M.2 Supports type:-| รองรับฟังก์ชั่น RAID:-# Expansion Slots=> รายละเอียด:1 Slot PCIe x16, 2 Slot PCIe x1| รับรอง Cross Fire / SLI:-# Network=> Chipset LAN:Realtek RTL8111GR| ความเร็ว LAN:10/100/1000Mbps# Rear Panel Ports=> Port USB 2.0:4 Port| Port USB 3.0:2 Port| Port USB 3.1:-| Dsub Output:1 Port| DVI Output:1 Port| HDMI Output:0 Port| Mini HDMI Outputv:0 Port| Display port:0 Port| Mini Display port:0 Port| Audio Output:3 Port| Port PS2:1 Port| Option Port:-# Physical Spec=> ชนิดของเมนบอร์ด:Micro-ATX| ช่องเสียบไฟ:24+4 Pin| ขนาด:18.3 x 22.6 cm# Warranty=> การรับประกัน:3 ปี', 'ASROCK', 'ASROCK H110M-DVS.jpg', 10, 4, '2018-07-15 15:41:13', 0),
(54, 'BLACKBERRY MAXIMUS DDR4 8GB 2400', 2900, 'Model=> Brand:BLACKBERRY| Model:MAXIMUS DDR4 8GB 2400# Specification=> ชนิดแรม:DDR4| ความจุ:8GB| Voltage:-| RAM Bus:2400| CL Timing:15# Warranty=> การรับประกัน:L/T ปี', 'BLACKBERRY', 'BLACKBERRY MAXIMUS DDR4 8GB 2400.jpg', 10, 6, '2018-07-15 15:41:13', 0),
(55, 'AERO COOL CS-100 (Black)', 890, '', 'AERO COOL', 'AERO COOL CS-100 (Black).jpg', 10, 1, '2018-07-15 15:41:13', 0),
(56, 'INTEL Core i7-7700K', 9700, 'Model=>Brand:INTEL|Model:Core i7-7700K#Specification=>Socket:LGA1151|CPU Core / Thread:4/8|Frequency:4.20 GHz|Turbo:4.50 GHz|CPU Bus:8 GT/s DMI|Architecture:14nm|Cache L2:4 x 256KB|Cache L3:8MB|Power Peak:91W#Warranty=>การรับประกัน:3 ปี', 'INTEL', 'INTEL Core i7-7700K.png', 10, 2, '2018-07-16 10:24:06', 0),
(57, 'INTEL Core i9-7980XE', 68500, 'Model=>Brand:INTEL|Model:Core i9-7980XE#Specification=>Socket:LGA2066|CPU Core / Thread:18/36|Frequency:2.60 GHz|Turbo:4.40 GHz|CPU Bus:8 GT/s DMI3|Architecture:14nm|Cache L2:-|Cache L3:24.75MB|Power Peak:165W#Warranty=>การรับประกัน:3 ปี', 'INTEL', 'INTEL Core i9-7980XE.png', 10, 2, '2018-07-16 13:55:54', 0),
(58, 'CORSAIR Harpoon RGB Gaming Mouse', 990, 'Model=> BrandCorsair:<br /><b>Notice</b>| ModelHarpoon RGB Gaming Mouse:<br /><b>Notice</b># Specification=> Interface:USB 2.0| Body Color:Black| Body Type:Plastic| Led:RGB| Max DPI:6000| Button:6| Mouse Hand:Right| Movement Tachnology:Optical| Sensor:Advanced Optical Gaming Sensor# Other Feature=> network Support:-| Feature:เมาส์ Harpoon RGB เป็นรุ่นล่าสุดที่ทาง Corsair ออกแบบมาสำหรับเกมเมอร์ที่ถนัดมือขวา สเปคเซ็นเซอร์แบบ Optical รีดความเร็วเมาส์ได้สูงสุด 6,000 DPI ระบบไฟแบบ RGB 16.8 ล้านสี กริปด้านข้างออกแบบ Texture แบบ 3D ให้การสัมผัสหนึบติดมือ ปุ่มมาโครเสริม 2 ปุ่มและสามารถเซ็ทมาโครได้บนเมาส์ทั้งหมด 6 ปุ่ม และน้ำหนักเบาเหมาะสำหรับการเพื่อการเคลื่อนไหวที่รวดเร็ว| Weight:85 กรัม Warranty', 'Corsair', 'CORSAIR Harpoon RGB Gaming Mouse.jpg', 10, 10, '2018-09-05 04:32:55', 0),
(59, 'DELL UltraSharp UP2718Q', 58900, 'Model=> Brand:DELL| Model:UltraSharp UP2718Q# Specification=> Full HD:Yes| Resolution:3840 x 2160| Refresh Rate6:0 Hz| Display Size Detail:27.00| Response Time:6ms# Connector=> VGA Port:0 Port| DVI Port:0 Port| HDMI Port:2 Port| Display Port:2 Port| USB Port:4 Port# Warranty=> การรับประกัน:3 ปี', 'DELL', 'DELL UltraSharp UP2718Q.png', 10, 8, '2018-09-05 04:32:17', 0),
(60, 'CORSAIR K95 Red Switch', 7900, 'Model=> Brand:Corsair| Model:K95 Red Switch# Specification=> Key Language:| Interface:| Case Color:| Backlit:| Key Switch Type:| Macro Keys:| Anti-ghosting:| Detail Spec:K95 RGB ใช้ Cherry MX Red ด้วยเอกลักษณ์เฉพาะของ Red ที่มีการตอบสนองที่รวดเร็วแม่นยำที่สุดในบรรดาทุกสีทำให้มันเป็นตัวเลือกแรก ของเหล่า Gamer เสมอมา อลูมิเนียมเกรดคุณภาพเดียว กับที่ใช้บนเครื่องบิน 100% anti-ghosting พร้อมกับ 104 key rollover แผ่นที่พักฝ่ามือแบบถอดได้ ตั้ง macro ได้หมดทุกปุ่มบน keyboard 18 ปุ่มเสริม G-keys เอนิเมชั่นแสงไฟที่ไหลลื่นด้วยแผงควบคุมจาก Panasonic Onboard memory เพื่อให้คุณสามารถพกคีย์บอร์ดไปกับคุณได้ทุกที่ทุกเวลา แผงควบคุม Multimedia เฉพาะ ไม่ต้องกด FN Key เพื่อใช้งานแต่อย่างใด ใช้ Corsair Utility Engine (CUE) เพื่อออกแบบเอนิเมชั่นไฟในของคุณเองได้อย่างอิสระ| Weight:-# Warranty=> การรับประกัน:1 ปี', 'Corsair', 'CORSAIR K95 Red Switch.jpg', 10, 9, '2018-07-25 18:44:19', 0);
...
CREATE TABLE `product_old` (
  `ProID` int(5) UNSIGNED ZEROFILL NOT NULL,
  `ProName` varchar(100) NOT NULL,
  `ProPrice` int(20) NOT NULL,
  `ProCtg` varchar(100) NOT NULL,
  `ProDct` varchar(500) NOT NULL,
  `ProBrand` varchar(100) NOT NULL,
  `ProPic` varchar(100) NOT NULL,
  `amount` int(2) NOT NULL,
  `ctg_id` int(5) UNSIGNED ZEROFILL NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
INSERT INTO `product_old` (`ProID`, `ProName`, `ProPrice`, `ProCtg`, `ProDct`, `ProBrand`, `ProPic`, `amount`, `ctg_id`) VALUES
(00001, 'AMDA6 7400k specifications', 6600, 'CPU', '', 'AMD', 'AMDA6_7400k.jpg', 10, 00002),
(00002, 'GEFORCE GTX 1060 GAMING X 6G', 12000, 'VGA CARD', '', 'MSI', 'MSI GTX1060 GAMING X.jpg', 18, 00007),
(00003, '4 GB RAM PC DDR3/1600 G.SKILL AEGIS', 1200, 'RAM', '', 'G.SKILL', 'G.SKILL AEGIS DDR3 4GB 1600.jpg', 8, 00006),
(00004, 'GIGABYTE GA-970 GAMING', 3500, 'MAIN BOARD', '', 'GIGABYTE', 'GIGABYTE GA-970 GAMING.jpg', 3, 00004),
(00005, 'SEAGATE BARRACUDA ', 3600, 'HARD DISK', 'SEAGATE 3TB', 'Seagate', 'SEAGATE BARRACUDA 3TB.jpg', 9, 00003),
(00006, 'TSUNAMI Black Strom', 2200, 'POWER SUPPLY', 'ATX 850W', 'Tsunami', 'TSUNAMI Black Strom 850W.jpg', 6, 00005),
(00007, ' Intel Pentium Processor G4560T', 2000, 'CPU', '', 'INTEL', 'INTEL Pentium G4400.jpg', 6, 00002),
(00008, 'AMD A6-7470K', 2400, 'CPU', 'SocketFM2+ CPU Core / Thread2/2 Frequency3.70 GHz Turbo4.00 GHz CPU BusN/A Architecture28nm Cache L21MB Cache L3- Power Peak65W', 'AMD', 'AMD A6-7470K.jpg', 8, 00002),
(00009, 'CPU AMD AM3+ FX-6300 3.5 GHz', 4000, 'CPU', '', 'AMD', 'AMD FX-6300.jpg', 10, 00002),
(00010, 'AMD Ryzen 3 1100', 4900, 'CPU', 'SocketAM4 CPU Core / Thread4/4 Frequency3.20 GHz Turbo3.50 GHz CPU Bus- Architecture14 nm Cache L2 Cache L38MB Power Peak65W', 'AMD', 'AMD Ryzen 3 1100.jpg', 10, 00002),
(00011, 'RAIDMAX RX-450SS', 1000, 'POWER SUPPLY', 'กำลังไฟสูงสุด450W', 'RAIDMAX', 'RAIDMAX RX-450SS.jpg', 8, 00005),
(00012, 'GIGABYTE R7 ', 2870, 'VGA CARD', 'ความจุ RAM2GB', 'GIGABYTE', 'GIGABYTE R7 350 Over Clock.jpg', 10, 00007),
(00013, 'SAPPHIRE R7 ', 2750, 'VGA CARD', 'ความจุ RAM2GB', 'SAPPHIRE', 'SAPPHIRE R7 250 2G D5.jpg', 10, 00007),
(00014, 'ZOTAC GTX1050 Mini', 4280, 'VGA CARD', 'ความจุ RAM2GB', 'ZOTAC ', 'ZOTAC GTX1050 Mini.jpg', 10, 00007),
(00015, 'GIGABYTE GTX1050 ', 4490, 'VGA CARD', 'ความจุ RAM2GB', 'GIGABYTE', 'GIGABYTE GTX1050 D5 2G.jpg', 9, 00007),
(00016, 'G.SKILL Ripjaws X ', 1420, 'RAM', 'ความจุ4GB', 'G.SKILL', 'G.SKILL Ripjaws X DDR3 4GB 1600 RL.jpg', 10, 00006),
(00017, 'KINGSTON Hyper-X Fury', 1380, 'RAM', 'ชนิดแรมDDR4 ความจุ4GB', 'KINGSTON', 'KINGSTON Hyper-X Fury DDR4 4GB 2400 Black.jpg', 8, 00006),
(00018, 'update', 222222, 'CPU', '', '', '', 88, 00001),
(00020, 'maxamxamxamx', 0, '', '', '', '', 0, 00005);
...
INSERT INTO `tb_member` (`UserID`, `Username`, `Password`, `Name`, `address`, `id_card`, `email`, `phone`, `pic`, `Status`) VALUES
(00001, 'maxsrisupan', '61129118', 'สุชาครีย์ ศรีสุพรรณ', '106 ม.3 ต.แก่งโสภา อ.วังทอง จ.พิษณุโลก', '', 'maxsrisupan@gmail.com', '0998277294', '12928261_1001862976534044_384097724651218075_n.jpg', 'ADMIN'),
(00002, 'max', '123', 'suchakri  srisupan', 'max', '1659900745771', 'maxo@gmail.com', '0888888888', '5.jpg', 'USER');
...
CREATE TABLE `tb_order` (
  ...
  `method_of_shipping` varchar(250) NOT NULL,
  ...
  `order_post` varchar(100) NOT NULL,
  `order_status` int(11) NOT NULL COMMENT '''0:รอการชำระเงิน'',''1:รอตรวจสอบการชำระเงิน'',''2:ชำระเงินแล้ว'',''3:กำลังส่งของ'',''4:ยกเลิก'''
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `tb_order` (`order_id`, `invoice`, `order_date`, `method_of_shipping`, `method_of_payment`, `bank_name`, `member_id`, `name`, `card_id`, `email`, `phone_number`, `address`, `order_post`, `order_status`) VALUES
(1, 2018061, '2018-06-15 10:09:40', 'self', 'Internet Banking', 'thaipanich', 1, 'สุชาครีย์ ศรีสุพรรณ', '1659900745771', 'maxsrisupan@gmail.com', '0998277294', '106/ม.12/ซ.-/ถ.-/จ.พิษณุโลก/อ.วังทอง/ต.แก่งโสภา/65220', 'TH-654301-654EN', 3),
(2, 2018062, '2018-06-17 12:36:47', 'self', 'ATM', 'krungthap', 1, 'สุชาครีย์ ศรีสุพรรณ', '1659900745771', 'maxsrisupan@gmail.com', '0998277294', '106/ม.12/ซ.-/ถ.-/จ.พิษณุโลก/อ.วังทอง/ต.แก่งโสภา/65220', '', 4),
(3, 2018063, '2018-06-17 19:22:34', 'shipping', 'ATM', 'krungthap', 1, 'สุชาครีย์ ศรีสุพรรณ', '1659900745771', 'maxsrisupan@gmail.com', '0998277294', '106/ม.12/ซ.-/ถ.-/จ.พิษณุโลก/อ.วังทอง/ต.แก่งโสภา/65220', '', 4),
(4, 2018064, '2018-06-17 19:23:43', 'self', 'ATM', 'thaipanich', 1, 'สุชาครีย์ ศรีสุพรรณ', '1659900745771', 'maxsrisupan@gmail.com', '0998277294', '106/ม.12/ซ.-/ถ.-/จ.พิษณุโลก/อ.วังทอง/ต.แก่งโสภา/65220', '', 4),
(5, 2018075, '2018-07-01 08:57:43', 'self', 'ATM', 'promptpay', 1, '', '', '', '', '', '', 4),
(6, 2018076, '2018-07-01 08:58:25', 'self', 'ATM', 'krungthap', 1, '', '', '', '', '', '', 4),
(7, 2018077, '2018-07-01 12:41:01', 'self', 'ATM', 'promptpay', 1, '', '', '', '', '', '', 4),
(8, 2018078, '2018-07-01 12:51:07', 'self', 'ATM', 'promptpay', 0, 'อนันต์ ศรีสุพรรณ', '1234567891011', 'max@gm.com', '0998888888', '901/ม.2/ซ.-/ถ.-/จ.กรุงเทพมหานคร/อ.เขตพระนคร/ต.พระบรมมหาราชวัง/10200', '', 4),
(9, 2018079, '2018-07-05 20:20:10', 'self', 'ATM', 'krungthai', 1, '', '', '', '', '', '', 4),
(10, 20180710, '2018-07-16 22:53:07', 'shipping', 'ATM', 'krungthai', 0, 'อนันต์ ศรีสุพรรณ', '5555555555555', 'max@gm.com', '0998888888', '901/ม.2/ซ.-/ถ.-/จ.ชลบุรี/อ.เมืองชลบุรี/ต.บางปลาสร้อย/20000', '', 1),
(11, 20180711, '2018-07-17 00:56:17', 'shipping', 'Internet Banking', 'krungthai', 0, 'อนันต์ ศรีสุพรรณ', '1659900745771', 'suchakri.s@psru.ac.th', '0805151199', '106/ม.3/ซ.-/ถ.-/จ.พิษณุโลก/อ.วังทอง/ต.แก่งโสภา/65220', 'TH-654301-654EN', 3),
(12, 20180712, '2018-07-17 02:53:32', 'self', 'ATM', 'krungthai', 1, '', '', '', '', '', '', 2),
(13, 20180713, '2018-07-17 10:24:07', 'self', 'ATM', 'krungthai', 0, 'อนันต์ ศรีสุพรรณ', '1659900745774', 'maxsrisupan@gmail.com', '0805151199', '901/98/ม.4/ซ.-/ถ.-/จ.สระแก้ว/อ.เมืองสระแก้ว/ต.สระแก้ว/27000', '', 1),
(14, 20180714, '2018-07-19 00:16:12', 'self', 'ATM', 'krungthai', 0, 'อนันต์ ศรีสุพรรณ', '1111111111111', 'suchakri.s@psru.ac.th', '0998277294', '5454/458/ม.10/ซ.-/ถ.-/จ.ฉะเชิงเทรา/อ.เมืองฉะเชิงเทรา/ต.หน้าเมือง/24000', '', 4),
(15, 20180715, '2018-07-19 00:41:24', 'self', 'ATM', 'krungthai', 1, '', '', '', '', '', '', 4),
(16, 20180716, '2018-07-25 01:02:46', 'self', 'ATM', 'krungthai', 1, '', '', '', '', '', 'TH-6798-546465-EN', 3),
(17, 20180717, '2018-07-26 01:09:21', 'self', 'ATM', 'krungthai', 1, '', '', '', '', '', 'TH-654301-654EN', 3),
(18, 20180718, '2018-07-26 01:20:28', 'self', 'ATM', 'thaipanich', 1, '', '', '', '', '', '', 2),
(19, 20180719, '2018-07-26 01:21:30', 'self', 'ATM', 'krungthai', 1, '', '', '', '', '', '', 2),
(20, 20180720, '2018-07-30 21:54:34', 'self', 'ATM', 'krungthai', 1, '', '', '', '', '', 'TH-6798-99999-EN', 3),
(21, 20180821, '2018-08-28 14:47:50', 'shipping', 'Internet Banking', 'promptpay', 4, '', '', '', '', '', 'TH-6798-546465-EN', 3),
(22, 20180822, '2018-08-30 12:22:46', 'self', 'ATM', 'krungthai', 3, '', '', '', '', '', '', 4),
(23, 20180923, '2018-09-16 00:15:42', 'shipping', 'Internet Banking', 'krungthai', 1, '', '', '', '', '', '', 4),
(24, 20181024, '2018-10-31 22:45:08', 'shipping', 'ATM', 'krungthai', 1, '', '', '', '', '', '', 0);
...
CREATE TABLE `tb_order_detail` (
  ...
  `order_id` int(5) NOT NULL COMMENT 'รหัสการสั่งซื้อ',
  `product_id` int(5) UNSIGNED ZEROFILL NOT NULL COMMENT 'รหัสสินค้า',
  `amount` int(5) NOT NULL COMMENT 'จำนวนสินค้าที่สั่ง'
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
INSERT INTO `tb_order_detail` (`detail_id`, `order_id`, `product_id`, `amount`) VALUES
(1, 1, 00002, 1),
(2, 1, 00003, 1),
(3, 1, 00004, 1),
(4, 2, 00002, 1),
...
--
ALTER TABLE `category`
  MODIFY `category_id` int(5) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT COMMENT 'รหัสประเภทสินค้า', AUTO_INCREMENT=11;
...
--
ALTER TABLE `product_old`
  MODIFY `ProID` int(5) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;

--
-- AUTO_INCREMENT for table `tb_member`
--
ALTER TABLE `tb_member`
  MODIFY `UserID` int(5) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
...
--
ALTER TABLE `tb_order_detail`
  MODIFY `detail_id` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=94;
COMMIT;
