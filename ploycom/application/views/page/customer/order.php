                ...
                <div class="row container margin-bottom">
                    ...
                    <div class="customer row">
                        <div class="customer-left-nav col l3 m3 s12 padding-small large bar-block" >
                            ...
                            <a href="<?php echo $this->base_url('customer/order') ?>" class="bar-item button theme-d2 ">รายการคำสั่งซื้อ</a>
                        ...
                        <div class="customer-content col l9 m9 s12 right" style="padding:10px;">
                            <table class="table-all order" border="1">
                                <thead>
                                    <tr class="theme">
                                        ...
                                        <th class="hide-small">วิธีชำระเงิน</th>
                                        <th>สถานะ</th>
                                        <th>ยืนยัน</th>
                                    ...
                                    <?php foreach ($order as $key => $value): ?>
                                        <tbody class="page">
                                            <tr class="theme-l5">
                                                ...
                                                <td class="hide-small"><?php echo $order[$key]->bank_name.' '.$order[0]->method_of_payment ?></td>
                                                ...
                                                <td class="center">
                                                    <?php if ($order[$key]->order_status == 'รอการชำระเงิน' || $order[$key]->order_status == 'รอตรวจสอบการชำระเงิน'): ?>
                                                    ...
                                                    <?php elseif($order[$key]->order_status == 'ชำระเงินแล้ว' || $order[$key]->order_status == 'ส่งของแล้ว'): ?>
                                                        <span class="text-green">ยืนยันสำเร็จ</span>
                                                    <?php endif; ?>
                                                </td>
                                                <td class="center"><?php echo $order[$key]->order_post ?></td>
                                            </tr>
                                            <tr class="bg-none">
                                                            ...
                                                            <?php foreach ($order[$key]->payment as $key_pay => $value_pay): ?>
                                                                <div class="col l2 m3 s5 margin-bottom margin-right">
                                                                    <div class="slip-img">
                                                                        ...
                                                                        <?php if ($order[$key]->payment[$key_pay]->status == 2): ?>
                            ...
                            <?php endif; ?>
                            <div class="center margin-top col s12">
                                <a href="<?php echo $this->base_url('customer/order/cancel') ?>" class="button red round">ดูใบสั่งที่ถูกยกเลิก</a>
                            </div>
                        </div>
                    </div>
                </div>
