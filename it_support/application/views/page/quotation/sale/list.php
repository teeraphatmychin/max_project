          ...
          <div class="collapse navbar-collapse max-top-nav justify-content-end">
            <ul class="nav justify-content-end">
                <?php //if ($_SESSION['user']->position == 'Service Ad.' or $_SESSION['user']->position == 'IT'): ?>
                    <li class="nav-item">
                        <a class="nav-link bg-success btn-modal-add-quotation" href="javascript:void(0)">
                        ...
                        <div class="card-body">
                                <form class="form-add-quotation">
                                    ...
                                    <div class="row">
                                        <div class="col-md-2 wrap-input">
                                            <div class="form-group bmd-form-group dropdown">
                                                <label class="bmd-label-floating"><strong>กรอกเลขที่ใบเสนอราคาเอง</strong></label>
                                                <input type="number" class="form-control" name="q_num_manual" value="">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 wrap-input">
                                            ...
                                            <div class="form-group bmd-form-group dropdown">
                                                ...
                                                <a class="" id="dropdown-q_topic" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                    <input type="text" class="form-control" name="q_topic" value="ขอเสนอราคา เวชภัณฑ์แพทย์" required>
                                                </a>
                                                <div class="dropdown-menu dropdown-menu-right dropdown-q_topic" style="left: 21% !important;" aria-labelledby="dropdown-q_topic">
                                                    <a class="dropdown-item" href="javascript:void(0)">วัสดุทางการแพทย์</a>
                                                    <a class="dropdown-item" href="javascript:void(0)">อุปกรณ์ทางการแพทย์</a>
                                                    <a class="dropdown-item" href="javascript:void(0)">เวชภัณฑ์ทางการแพทย์</a>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-12 wrap-input">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group bmd-form-group">
                                                <label for="validationTextarea" class="text-dark"><b>หมายเหตุ</b></label>
                                                <textarea class="form-control" id="validationTextarea" name="q_a_note"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <?php if ($_SESSION['user']->position == 'Admin Sale Manager' or $_SESSION['user']->position == 'Sale Manager' or $_SESSION['user']->position == 'Area Manager'): ?>
                                    ...
                                    <div class="row">
                                        <div class="max-col-sm-2 col-md-3">
                                            ...
                                            <div class="form-check row d-flex justify-content-center">
                                                ...
                                                <div class="max-col-sm-9 col-md-8 text-left text-dark" style="padding-left: 10px;"><strong>หมายเหตุ</strong></div>
                                            </div>
    ...
    $(document).ready(function() {
        ...
        .on('click','.modal-note',function(){
            ...
            if ($(this).prop('checked')) {
                ...
                wrap.find('.wrap-list-note').html(html);
            }else {
        ...
        .on('click','.dropdown-q_topic .dropdown-item',function(){/*dropdown q_to_detail*/
            let value = $(this).html();
            $(this).closest('.dropdown').find('input').val('ขอเสนอราคา '+value);
        })
        ...
        $('.btn-modal-add-quotation').click(function(){
            setTimeout(function(){
                ...
                // console.log($('.row-add-quotation .form-add-quotation .wrap-list-q_product select.list-product'));
                    ...
                    $.ajax({
                        ...
                        success: function(data){
                            ...
                            if (data[0] == 'success') {
                                ...
                                // setTimeout(function(){tag.closest('.form-group').find('.max-wrap-chosen .max-chosen-drop .max-chosen-search .max-chosen-search-input').val(data[2]);},800);
                    ...
                    $.ajax({
                        ...
                        success: function(data){
                            ...
                            if (data[0] == 'success') {
                                ...
                                html += '</div>';
                                html += '<div class="row col-md-12 justify-content-end d-flex">';
                                html += '<div class="q_date" style="width:fit-content"><i>เลขประจำตัวผู้เสียภาษี 0105529003833</i></div>';
                                html += '</div>';
                                ...
                                // html += '<div class="text-right col-md-12" style="font-size:28px;color:#0043ff"><u>'+value.q_agent+'</u></div>';
                                ...
                                // if (value.list_detail != '') {
                                    html += '<tr>';
                                    html += '<td colspan="" style="border-top:0px !important"></td>';
                                    html += '<td colspan="" style="border-top:0px !important"></td>';
                                    // html += '<td colspan="" style="border-top:0px !important">'+value.list_detail+'</td>';
                                    html += '<td colspan="" style="border-top:0px !important">';
                                    html += '<div class="row">';
                                    html += '<div class="col-md-8 row">';
                                    $.each(value.list_detail,function(key_detail,value_detail){
                                        html += '<div class="col-md-6" >'+value_detail+'</div>';
                                    });
                                    html += '</div>';
                                    html += '</div>';
                                    html += '</td>';
                                    html += '<td colspan="" style="border-top:0px !important" class="border-top-0"></td>';
                                    html += '<td colspan="" style="border-top:0px !important" class="border-top-0"></td>';
                                    html += '</tr>';
                                // }
                                html += '<tr>';
                                ...
                                html += '<div class="form-check">';
                                html += '<label class="form-check-label">';
                                html += '<input class="form-check-input signature" type="checkbox" name="signature" value="gm" checked>';
                                html += '<span class="form-check-sign">';
                                html += '<span class="check"></span>';
                                html += '</span>';
                                html += '</label>';
                                html += '</div>';
                                html += '</div>';
                                html += '<div class="max-col-sm-7 col-md-7 text-center pr-0" style="padding-top: 8px;padding-left: 1px;">ลายเซ็นต์ผู้จัดการ</div>';
                                html += '</div>';
                                html += '<div class="row max-col-sm-12 col-md-12 pr-0">';
                                html += '<div class="max-col-sm-2 col-md-2">';
                                html += '<div class="form-check">';
                                html += '<label class="form-check-label">';
                                html += '<input class="form-check-input signature" type="checkbox" name="signature" value="sale">';
                                html += '<span class="form-check-sign">';
                                html += '<span class="check"></span>';
                                html += '</span>';
                                html += '</label>';
                                html += '</div>';
                                html += '</div>';
                                html += '<div class="max-col-sm-7 col-md-7 text-center pr-0" style="padding-top: 8px;padding-left: 1px;">ลายเซ็นต์ตัวแทนฝ่ายขาย</div>';
                                html += '</div>';
        ...
        function option_click(data){
            $('.modal-preview-quotation .modal-content').off();
            $('.modal-preview-quotation .modal-content').on('click','.btn-option[option-type=edit],.btn-option[option-type=duplicate]',function(){
                $('.loading-screen').show();
            });
            $('.modal-preview-quotation .modal-content').on('click','.btn-option',function(){
                ...
                switch (option_type) {
                    case 'edit': //modal edit
                        setTimeout(function(type = option_type){
                            ...
                            $('.row-add-quotation .card .card-body input[name=q_job_number]').val(data.q_job_number);
                            $('.row-add-quotation .card .card-body input[name=q_customer_department]').val(data.q_customer_department);
                            if (data.q_discount_text != '') {
                                console.log(data);
                                console.log(data.q_discount_text);
                                $('.row-add-quotation .card .card-body input[name=q_discount]').val(data.q_discount_text);
                                if (data.q_discount_type == 'percent') {
        ...
        $('.form-add-quotation').on('click','.wrap-btn-add-q_product .btn-add-q_product',function(){
            ...
            $(this).closest('.form-add-quotation').find('.list-q_product:last-child select.list-product').html('<option>ค้นหาสินค้า...</option>');
