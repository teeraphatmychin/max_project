 ...
 <script src="<?php echo $this->public_url('libs/chosen/js/chosen.jquery.min.js') ?>"></script>
  ...
  <script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        //old function list product sale
        ...
        //list_product from service
        function list_product(list_status = ''){ //list product
            ...
            let last_date = '';
            let status = 'get';
                if (typeof $('.content .list-product tbody').attr('last-date') !== typeof undefined) {
        ...
        $('.list-product').on('click','.btn-option',function(){
        ...
        function validate(){
            $('.row-add-product *[name*=p_]').each(function(key,value){
                ...
                if ($(this).val() == '' && $(this).attr('name') != 'p_sub_detail' && $(this).attr('name') != 'p_cate' && $(this).attr('name') != 'p_brand') {
