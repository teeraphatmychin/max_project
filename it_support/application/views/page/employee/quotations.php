    ...
    <div class="main-panel">
        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse max-top-nav justify-content-end">
            <ul class="nav justify-content-end">
              <li class="nav-item">
                  <a class="nav-link btn-modal-add-issue bg-success" href="javascript:void(0)">
      ...
      <div class="content">
        <div class="container-fluid">
                  ...
                  <div class="row justify-content-around d-flex">
                    <div class="form-group">
                        ...
                        <div class="form-group bmd-form-group">
                            <input type="text" class="form-control search-date-start" name="search-number"  value="">
                        </div>
                    </div>
                    <div class="form-group">
            ...
            <hr>
            <div class="row row-add-quotations">
                <div class="col-md-12">
                    <div class="card">
                        <div class="row justify-content-between pl-4 pr-4">
                            <div class="col-md-9 card-header card-header-info">
                                <h4 class="card-title">สร้างใบเสนอราคา</h4>
                            </div>
                            <div class="col-md-2 card-header card-header-info">
                                <p class="card-category text-white">เลขที่ : SER.792/2562</p>
                                <p class="card-category text-white">วันที่ 29 สิงหาคม 2562</p>
                            </div>
                        </div>
                                ...
                                <form>
                                    <div class="wrap-form col-md-12">
                                        <div class="form-group row">
                                            <label for="metter" class="col-md-1 pt-2" style="max-width: 5.333333%;">เรื่อง : </label>
                                            <input type="text" class="form-control col-md-10" value="ขอเสนอราคา อะไหล่ชุดวัดชีพจร รุ่น M3001A">
                                        </div>
                                        <div class="form-group row">
                                            <label for="metter" class="col-md-1 pt-2" style="max-width: 5.333333%;">เรียน : </label>
                                            <input type="text" class="form-control col-md-10" value="ผู้อำนวยการ โรงพยาบาล">
                                        </div>
                                        <div class="form-group row">
                                            <label for="metter" class="col-md-1 pt-2" >รายละเอียด : </label>
                                            <textarea class="form-control" name="eq_detail" rows="5">               บริษัทฯ มีความยินดีเสนอราคา อะไหล่ชุดวัดสัญญาชีพ รุ่น M3001A หมายเลขเครื่อง DE632F7914
ผลิตภัณฑ์ PHILIPS จากสหัรัฐอเมริกา มีรายละเอียดกังต่อไปนี้</textarea>
                                        </div>
                                    </div>
                                </form>
                            </div>
                                ...
                                <table class="table" border="1">
                                    ...
                                    <tbody class="text-center">
                                        <tr>
                                            ...
                                            <td style="border-bottom:0px"><select class="form-control text-center" name=""><option value="1">1</option><option value="2">2</option><option value="1">3</option><option value="1">4</option><option value="4">5</option></select></td>
                                            <td style="border-bottom:0px"><input type="text" class="form-control" name="" value="453564748091 : MS_X1 NBP Pump Assembly for X1/X2/MP2"></td>
                                            <td style="border-bottom:0px"><input type="text" class="form-control text-center" name="" value="33,250.00"></td>
                                            <td style="border-bottom:0px">33,250.00</td>
                                        </tr>
                                        <tr >
                                            <td style="border-top:0px"></td>
                                            <td style="border-top:0px"></td>
                                            <td style="border-top:0px" class="text-left">เลขครุภัณฑ์ 6515-038-0009-011.1-50</td>
                                            <td style="border-top:0px"></td>
                                            <td style="border-top:0px"></td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td style="border-bottom:0px">ราคาสินค้า</td>
                                            <td style="border-bottom:0px">33,250.00</td>
                                        </tr>
                                        <tr>
                            ...
                            <div class="card-footer text-center justify-content-between">
                                <a class="btn btn-danger btn-cancel-quotations" href="javascript:void(0)"><h4><i class="material-icons mr-3">cancel</i>ยกเลิก</h4></a>
                                <a class="btn btn-success" href="<?php echo $this->base_url('employee/print_quotations') ?>"><h4><i class="material-icons mr-3">print</i>สั่งพิมพ์</h4></a>
                            </div>
                        </div>
                    </div>
  ...
  <script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        function list_issue(data_search = []){
