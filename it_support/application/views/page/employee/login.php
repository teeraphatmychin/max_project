...
<body class="">
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-8 col-sm-12">
                            <div class="card">
                                <div class="card-header card-header-primary">
                                    <h4 class="card-title text-center">OFFICE XOVIC</h4>
  ...
  <script type="text/javascript">
    $(document).ready(function() {
        //validate input
        let check_session = '<?php echo $check_session ?>';
        if (check_session != '') {
            Swal.fire({
                type: 'info',
                ...
                window.location.href = '<?php echo $this->base_url('page/') ?>'+check_session;
            });
        }
        $('.form-login')
                ...
                success: function(data){
                    ...
                    switch (data[0]) {
                        case 'fail':
                            ...
                            break;
                        case 'success':
                            window.location.href = '<?php echo $this->base_url('page/') ?>'+data[1];
                            break;
                        case 'isset':
                            Swal.fire({
                                type: 'info',
                        ...
                        case 'No Permission':
                            Swal.fire({
                                type: 'info',
                                title: 'คุณยังไม่ได้รับสิทธิ์การใช้งาน',
                                text: 'กรุณาติดต่อ Programmer',
                            }).then((result) => {
                                window.location.href = '<?php echo $this->base_url('page/') ?>'+data[1];
                            });
                            break;
