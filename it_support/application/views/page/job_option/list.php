        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                ...
                <div class="modal-body wrap-data-job p-3" style="font-size: 14px;">
                    <div class="row">
                        <div class="col-md-12 text-center">โรงพยาบาล แผนก CCU</div>
                        <div class="row m-0 col-sm-12 col-md-6 mt-2 mb-2 " style="font-size:0.8rem">
                            <div class="col-sm-12 col-md-12 col-lg-12 row m-0">
                                <div class="row m-0 border rounded">
                                    <div class="col-md-12 border-bottom text-center text-white bg-primary" style="border-radius: 6px 6px 0px 0px"><strong>ข้อมูลผู้แจ้ง</strong></div>
                                    <div class="col-sm-4 col-md-4 border-bottom border-right"><strong>ชื่อ :</strong></div>
                                    <div class="col-sm-8 col-md-8 border-bottom">สมมติ สมมติ</div>
                                    <div class="col-sm-4 col-md-4 border-bottom border-right"><strong>เขต :</strong></div>
                                    <div class="col-sm-8 col-md-8 border-bottom">XO.105/99</div>
                                    <div class="col-sm-7 col-md-4 border-right border-bottom"><strong>เบอร์โทรติดต่อ :</strong></div>
                        ...
                        <div class="row m-0 col-sm-12 col-md-6 mt-2 mb-2" style="font-size:0.8rem;height: fit-content;">
                            <div class="col-sm-12 col-md-12 col-lg-12 row m-0">
                                <div class="row m-0 border rounded col-12 p-0">
                                    <div class="col-md-12 border-bottom text-center text-white bg-primary" style="border-radius: 6px 6px 0px 0px"><strong>ข้อมูล IT</strong></div>
                                    <div class="col-sm-4 col-md-4 border-bottom border-right"><strong>ผู้รับเรื่อง :</strong></div>
                                    <div class="col-sm-8 col-md-8 border-bottom">สมมติ สมมติ</div>
                                    <div class="col-sm-4 col-md-4 border-bottom border-right"><strong>วันที่รับเรื่อง :</strong></div>
                                    <div class="col-sm-8 col-md-8 border-bottom">สมมติ สมมติ</div>
                                    <div class="col-sm-4 col-md-4 border-bottom border-right"><strong>ผู้รับผิดชอบงาน :</strong></div>
                                    <div class="col-sm-8 col-md-8 border-bottom">สมมติ สมมติ</div>
                                </div>
                            </div>
                        </div>
                        <div class="row m-0 col-sm-12 col-md-6 mt-2 mb-2" style="font-size:0.8rem">
                            <div class="col-sm-12 col-md-12 col-lg-12 row m-0">
                                <div class="col-12 row m-0 border rounded p-0">
                                    <div class="col-md-12 border-bottom text-center text-white bg-primary" style="border-radius: 6px 6px 0px 0px"><strong>ข้อตกลงการแจ้งงาน</strong></div>
                                    <div class="col-sm-12 col-md-5 border-bottom border-right"><strong>รายละเอียดผลิตภัณฑ์ :</strong></div>
                                    ...
                                    <div class="col-sm-12 col-md-5 border-bottom border-right"><strong>สิ่งที่ต้องการให้มีเพิ่ม :</strong></div>
                        ...
                        <div class="row m-0 col-sm-12 col-md-6 mt-2 mb-2" style="font-size:0.8rem;height: fit-content;">
                            <div class="col-md-12 row m-0">
                                <div class="row m-0 border rounded col-12 p-0">
                                    <div class="col-sm-12 col-md-12 col-lg-12 border-bottom text-center text-white bg-primary" style="border-radius: 6px 6px 0px 0px"><strong>สถานะใบแจ้งงาน</strong></div>
                                    <div class="col-12 border-bottom text-center"><strong>สร้างใหม</strong>่</div>
                                    <div class="col-12 border-bottom border-right bg-primary text-white text-center"><strong>ดำเนินการแล้วเสร็จ</strong></div>
                                    <div class="col-sm-4 col-md-4 border-bottom border-right"><strong>วันที่ :</strong></div>
                                    <div class="col-sm-8 col-md-8 border-bottom">สมมติ สมมติ</div>
                                    <div class="col-sm-4 col-md-4 border-bottom border-right"><strong>หมายเหตุ :</strong></div>
                                    <div class="col-sm-8 col-md-8 border-bottom">สมมติ สมมติ</div>
                                </div>
                            </div>
                        </div>
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top">
          <div class="container-fluid">
              <div class="navbar-wrapper">
                  <a class="navbar-brand" href="#pablo">รายการใบแจ้งงาน</a>
              </div>
                  ...
                  <ul class="nav justify-content-end">
                      <li class="nav-item">
                          <a class="nav-link bg-success btn-modal-add-job" href="javascript:void(0)">
                              ...
                              <p class="text-white d-block">สร้างใบแจ้งงาน</p>
                          </a>
                      </li>
                  </ul>
              </div>
      ...
      <div class="content pl-0 pr-0">
        <div class="col-md-12 col- d-lg-none d-md-block d-sm-block p-3 text-right">
            <button class="btn max-col-sm-12 col-md-3 bg-success btn-modal-add-job" >
                    <i class="material-icons text-white">add_circle</i>&nbsp;&nbsp;สร้างใบแจ้งงาน
            </button>
        </div>
        <div class="container-fluid">
                ...
                <div class="col-md-12 wrap-card-job">
                    <div class="card">
                        <div class="card-header card-header-info header-add-job">
                            <h4 class="card-title">สร้างใบแจ้งงาน</h4>
                        </div>
                        <div class="row justify-content-between pl-4 pr-4 header-edit-job" style="display:none">
                            <div class="col-md-8 card-header card-header-info">
                                <h4 class="card-title">แก้ไขใบแจ้งงาน</h4>
                            </div>
                        ...
                        <div class="card-body">
                            <form class="form-add-job">
                                ...
                                <div class="row">
                                    ...
                                    <!-- <div class="col-md-12 p-2 mb-1 rounded customer-detail-head text-center bg-info text-white shadow-sm"><h4><b>ข้อมูลผู้แจ้ง</b></h4></div> -->
                                    <div class="col-lg-3 col-md-12 wrap-input">
                                        <div class="form-group bmd-form-group">
                                            <label class="bmd-label-floating text-muted"><strong>วันทีแจ้ง</strong></label>
                                    ...
                                    <div class="col-lg-7 col-md-12 wrap-input">
                                        <div class="form-group bmd-form-group">
                                            <label class="bmd-label-floating text-muted"><strong>ชื่อผู้แจ้ง</strong></label>
                                    ...
                                    <div class="col-lg-2 col-md-12 wrap-input">
                                        <div class="form-group bmd-form-group">
                                            <label class="bmd-label-floating text-muted"><strong>เขต</strong></label>
                                ...
                                <div class="row">
                                    <div class="col-lg-3 col-md-12 wrap-input">
                                        <div class="form-group bmd-form-group is-filled">
                                            <label class="bmd-label-floating"><strong>เบอร์โทร</strong></label>
                                ...
                                <div class="row">
                                    <!-- <div class="col-md-12 p-2 mb-1 rounded customer-detail-head text-center bg-info text-white shadow-sm"><h4><b>ข้อตกลงการแจ้ง</b></h4></div> -->
                                ...
                                <div class="row">
                                    <div class="col-md-12 wrap-input">
                                        <div class="form-group">
                                            <label class="bmd-label-floating text-dark"><strong>รายละเอียดผลิตภัณฑ์</strong></label>
                                            <div class="form-group bmd-form-group">
                                ...
                                <div class="row">
                                    <div class="col-md-12 wrap-input">
                                        <div class="form-group">
                                            <label class="bmd-label-floating text-dark"><strong>สิ่งที่ต้องการให้มีเพิ่มเติม</strong></label>
                                            <div class="form-group bmd-form-group">
                                ...
                                <div class="row">
                                    <div class="col-md-12 wrap-input">
                                        <div class="form-group">
                                            <label class="bmd-label-floating text-dark"><strong>ต้องการความช่วยเหลือ</strong></label>
                                            <div class="form-group bmd-form-group">
                        ...
                        <div class="card-footer text-center justify-content-between">
                            <a class="btn btn-danger btn-cancel-job" href="javascript:void(0)"><h4><i class="material-icons mr-3">cancel</i>ยกเลิก</h4></a>
                            <a class="btn btn-success btn-add-job" href="javascript:void(0)"><h4><i class="material-icons mr-3">save</i>บันทึก</h4></a>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="form-group">
                            <div class="form-group bmd-form-group pl-1 pr-1">
                                <select class="custom-select search-cate" name="search-cate">
                                    ...
                                    <option value="accept">รับเรื่องแล้ว</option>
                                    <option value="success">ดำเนินการเรียบร้อย</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group">
                  ...
                  <div class="card card-equipment-list">
                    <div class="card-header row d-flex justify-content-between">
                        <div class="card-header-info max-col-sm-10 col-md-7 col-lg-7">
                            <h4 class="card-title">รายการแจ้งงาน</h4>
