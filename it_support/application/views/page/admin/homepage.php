...
<body class="">
  <div class="wrapper ">
    <div class="sidebar" data-color="purple" data-background-color="white" data-image="<?php echo $this->public_url('file/images/background/photo-1394134.jpg') ?>">
      <!--
    ...
    -->
      ...
      <div class="sidebar-wrapper">
        <ul class="nav">
          ...
          <li class="nav-item ">
            <a class="nav-link" href="<?php echo $this->base_url('admin/issue_list') ?>">
              <i class="material-icons">person</i>
              <p>รายการแจ้งปัญหา</p>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="<?php echo $this->base_url('admin/equipment_list') ?>">
    ...
    <div class="main-panel">
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="javascript:void(0)">หน้าหลัก</a>
          </div>
      ...
      <div class="content">
        <div class="container-fluid">
          <div class="row">
            <div class="col-lg-3 col-md-6 col-sm-6 btn-report" url="<?php echo $this->base_url('admin/issue_list') ?>">
              <div class="card card-stats">
                <div class="card-header card-header-danger card-header-icon">
                  <div class="card-icon">
                    <i class="material-icons">info_outline</i>
                  </div>
                  <p class="card-category">การแจ้งปัญหา</p>
                  <h3 class="card-title"><span>9</span>
                    <small>รายการ</small>
                  </h3>
                </div>
                <div class="card-footer">
                  <div class="stats">
                    ...
                    <a href="javascript:void(0)">มีการแจ้งปัญหาวันนี้</a>
                  </div>
                </div>
              </div>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-6 btn-report" url="<?php echo $this->base_url('admin/equipment_list') ?>">
              <div class="card card-stats">
                <div class="card-header card-header-success card-header-icon">
                  <div class="card-icon">
                    <i class="material-icons">desktop_windows</i>
                  </div>
                  <p class="card-category">รายการอุปกรณ์</p>
                  <h3 class="card-title num-equipment"><span>0</span>
                    <small>รายการ</small>
                  </h3>
                </div>
                <div class="card-footer">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 btn-report" url="<?php echo $this->base_url('admin/') ?>">
              <div class="card card-stats">
  ...
  <script>
    $(document).ready(function() {
        ...
        $('.content').on('click','.btn-report',function(){
            let url = $(this).attr('url');
            window.location.href = url;
        });
        $.ajax({
            url: '<?php echo $this->base_url('admin/equipment_list_ajax') ?>',
            method: 'post',
            data:{type:'num'},
            dataType: 'json',
            success: function(data){
                $('.num-equipment span').html(data[1]);
            }
        });
