        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="myExtraLargeModalLabel">เพิ่มรายชื่ออึปกรณ์</h5>
      ...
      <div class="sidebar-wrapper">
        <ul class="nav">
          ...
          <li class="nav-item active-pro">
            <a class="nav-link bg-danger text-white" href="<?php echo $this->base_url('admin/logout') ?>">
              <i class="material-icons text-white">cancel</i>
              <p>ออกจากระบบ</p>
            </a>
          </li>
          <!-- <li class="nav-item ">
  ...
  <script>
    $(document).ready(function() {
        ...
        function issue_list(){
            ...
            $.ajax({
                url: '<?php echo $this->base_url("admin/issue_list_ajax") ?>',
                dataType: 'json',
                success: function(data){
                    // console.log(data);
                    if (data[0] == 'success') {
