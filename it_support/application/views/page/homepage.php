  ...
  <div class="wrapper ">
    ...
    <div class="main-panel">
      ...
      <div class="content">
        <div class="container-fluid">
          <div class="row">
            <div class="col-lg-3 col-md-6 col-sm-6 btn-report" url="<?php echo $this->base_url('page/issue') ?>">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 btn-report" url="<?php echo $this->base_url('page/equipment') ?>">
              <div class="card card-stats">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 btn-report" url="<?php echo $this->base_url('page/') ?>">
              <div class="card card-stats">
