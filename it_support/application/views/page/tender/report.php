      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="#pablo">รายงาน tender</a>
          </div>
            ...
            <!-- <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="card card-stats">
                    <div class="card-header card-header-warning card-header-icon">
                        ...
                        <p class="card-category">มูลค่าทั้งหมด</p>
                                  ...
                                  <ul class="nav nav-tabs" data-tabs="tabs">
                                      <li class="nav-item">
                                          <a class="nav-link active" href="#profile" data-toggle="tab">
                                              <i class="material-icons">analytics</i> สรุปรายงาน
                                              <div class="ripple-container"></div>
                                          </a>
                                      </li>
                                      <li class="nav-item">
                                          <a class="nav-link" href="#messages" data-toggle="tab">
                                              <i class="material-icons">code</i> รายการ tender
                                              <div class="ripple-container"></div>
                                          </a>
                                      </li>
                                      <!-- <li class="nav-item">
                            ...
                            <div class="tab-pane active" id="profile">
                                <table class="table table-hover table-bordered tb-tender-list">
                                    <thead class="text-info">
                                        <tr>
                                            <th rowspan="2" class="text-center ">ชื่อ / เขต</th>
                                            <th colspan="3" class="text-center bg-light-info">สถานะงาน</th>
                                            <th rowspan="2" class="text-center bg-light">รวม</th>
                                        </tr>
                                        <tr>
                                            <th class="text-center text-success bg-light-success">ได้งาน</th>
                                            <th class="text-center text-danger bg-light-danger">ไม่ได้งาน</th>
                                            <th class="text-center text-warning bg-light-warning">รอ</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                    </tbody>
