...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 17, 2019 at 04:30 PM
...
(1, 'http://localhost/travelblog/public/file/images/15673145480.jpg', ' ทดสอบข้อความโฆษณา');
...
--
-- Table structure for table `tb_car_rent`
--

CREATE TABLE `tb_car_rent` (
  `car_rent_id` int(11) NOT NULL,
  `car_rent_name` text NOT NULL,
  `car_rent_detail` text NOT NULL,
  `car_rent_img` text NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `tb_car_rent`
--

INSERT INTO `tb_car_rent` (`car_rent_id`, `car_rent_name`, `car_rent_detail`, `car_rent_img`) VALUES
(1, 'The One Car Rent', 'โทรศัพท์ : 096-663-6636\r\n48/11 หมู่ที่ 5 ต.พลายชุมพล อ.เมือง จ.พิษณุโลก 65000', 'http://localhost/travelblog/public/file/images/15678327640.jpg'),
(2, 'เจมส์บอนรถเช่าพิษณุโลก', 'โทรศัพท์ : 086-446-1285\r\nบริการเช่าขับเอง ฟรีประกันชั้น 1\r\nราคาเริ่มต้น 900 บาท/วัน', 'http://localhost/travelblog/public/file/images/15678328580.jpg');
...
(1, 'ถนนคนเดิน', 'สถานที่ท่องเที่ยว 9 อำเภอ', 'http://localhost/travelblog/public/file/images/15672899730.jpg', 'attractions'),
(2, 'Amarin Lagoon Hotel', 'ที่พัก 9 อำเภอ', 'http://localhost/travelblog/public/file/images/accommodation/mueang_phitsanulok/Amarin_Lagoon_Hotel.jpg', 'accommodation'),
(3, 'ก๋วยเตี๋ยวโชคอำนวย (เกียมอี๋)', 'รัานอาหาร', 'http://localhost/travelblog/public/file/images/restaurant/mueang_phitsanulok/ก๋วยเตี๋ยวโชคอำนวย_เกียมอี๋.jpg', 'restaurant');
...
(1, 'ร้าน น.จิตร', 'โทรศัพท์ : 0-5525-8992\r\nเปิด : ทุกวัน 8.00 น. - 18.00 น.\r\n', 'http://localhost/travelblog/public/file/images/15672964970.jpg'),
(2, 'ร้านบิ๊กแบงค์', 'ที่อยู่ : วัดพระศรีรัตนมหาธาตุ\r\n\r\nเปิด : ทุกวัน 8.00 น. - 18.00 น.', 'http://localhost/travelblog/public/file/images/15672918520.jpg');
...
--
-- Indexes for table `tb_car_rent`
--
ALTER TABLE `tb_car_rent`
...
--
-- AUTO_INCREMENT for table `tb_car_rent`
--
ALTER TABLE `tb_car_rent`
