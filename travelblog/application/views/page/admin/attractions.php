				...
				<div class="modal-content modal-xl">
					...
					<div class="modal-body">
						<form class="" action="<?php echo $this->base_url('admin/add_item') ?>" method="post" enctype="multipart/form-data">
							<input type="hidden" name="place_type" value="attractions">
							...
							<div class="row pl-5 pr-5">
								<div class="col-md-12">
									<div class="form-group">
										...
										<!-- <label class="btn btn-warning text-white btn-select-image" for="image_record"><i class="nc-icon nc-simple-add"></i> เลือกรูปภาพ</label> -->
						...
						<div class="col fill_height no-padding">
							...
							<div class="search_tabs_container">
								<div class="search_tabs d-flex flex-lg-row flex-column align-items-lg-center align-items-start justify-content-lg-between justify-content-start">
									...
									<a href="<?php echo $this->base_url('admin/attractions') ?>" class="search_tab active d-flex flex-row align-items-center justify-content-lg-center justify-content-start">ที่เที่ยว</a>
        ...
        <div class="intro">
    		<div class="container">
				<div class="row intro-item col-md-6" style="float:unset;margin:auto;margin-bottom:15px;">
                    <button type="button" class="btn btn-success btn-add col-md-12" style="" name="button"><i class="fa fa-plus-square" style="margin-right:5px;"></i>เพิ่มที่เที่ยว</button>
                </div>
    ...
    $(document).ready(function(){
		...
		.on('click','.btn-delete',function(){
			...
			swal({
				...
				if (result) {
					window.location.href = '<?php echo $this->base_url("admin/delete_item") ?>/'+id+'/attractions';
				}
			})
		})
