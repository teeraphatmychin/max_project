...
<div class="super_container">
					...
					<div class="col main_nav_col d-flex flex-row align-items-center justify-content-start">
						...
						<div class="main_nav_container ml-auto">
							<ul class="main_nav_list">
								...
								<li class="main_nav_item active"><a href="javascript:void(0)">ร้านอาหาร</a></li>
	...
	<div class="home">
        <h1 class="discription text-center">ร้านอาหาร</h1>
        <h2 class="discription text-center" style="padding-top: 5px;">ร้านอาหารยอดนิยม</h2>
    </div>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $('.intro').on('click','.intro_item',function(){
            ...
            window.location.href = "<?php echo $this->base_url('customer/restaurant/') ?>"+id+'/'+amphur_id;
        });
