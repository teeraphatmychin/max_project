...
<div class="super_container">
					...
					<div class="col main_nav_col d-flex flex-row align-items-center justify-content-start">
						...
						<div class="main_nav_container ml-auto">
							<ul class="main_nav_list">
								...
								<li class="main_nav_item active"><a href="javascript:void(0)">ร้านขายของฝาก</a></li>
	...
	<!-- Home -->
	<div class="home">
        <h1 class="discription text-center">ร้านของฝาก</h1>
	</div>
	<!-- Intro -->
	<div class="intro">
        <div class="container list-souvenir-shop">
        </div>
	</div>
	<!-- Footer -->
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            $('.input-search').keyup(function(){
                ...
                if (search != '') {
                    $('.intro .list-souvenir-shop').find('.offers_col').each(function(key,value){
                        $(this).hide();
                        if ($(this).find('.shop_name').text().toLowerCase().indexOf(search) > -1) {
                            $(this).show();
                        }
                    });
                }else {
                    $('.intro .list-souvenir-shop').find('.offers_col').show();
                }
            });
            function get_ad(){
				$.ajax({
            ...
            function list_souvenir_shop() {
    			$.ajax({
    				url: '<?php echo $this->base_url('customer/list_souvenir_shop') ?>',
    				dataType: 'json',
    				success: function(data){
    					if (data[0] == 'success') {
    						let html = '';
    						...
    						$.each(data[1],function(key,value){
    							if ((key+1) %2 == 0) {
    								html += '<div class="offers_col shadow rounded overflow-hidden ">';
